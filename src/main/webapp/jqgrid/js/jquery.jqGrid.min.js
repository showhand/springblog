...
(function (b) {
    ...
    b.extend(b.jgrid, {htmlDecode: function (e) {
        if (e && (e == "&nbsp;" || e == "&#160;" || e.length === 1 && e.charCodeAt(0)
            === 160)) {
            return"";
        }
        ...
        e || (e = "{}");
        return b.jgrid.useJSON === true && typeof JSON === "object" && typeof JSON.parse ===
        ...
        if (i && i !== null && i !== undefined) {
            ...
            i = i.split(c);
            e = e.split(c);
            var l = b.jgrid.formatter.date.monthNames, a = b.jgrid.formatter.date
                .AmPm, q = function (x, y) {
                if (x === 0) {
                    if (y === 12) {
                        y = 0
        ...
        return(e ?
               e : b.jgrid.uidPref) + b.jgrid.guid++
        ...
        ajaxOptions: {}, from: function (e) {
            return new function (i, g) {
                ...
                var c = this, h = i, k = true, l = false, a = g, q = /[\$,%]/g, x = null, y = null, E = 0, I = false, M = "", N =
                    [], V = true;
                ...
                this._getOrder = function (o, n, t, F, T) {
                    ...
                    fa =
                    F == "float" || F == "number" || F == "currency" || F == "numeric"
                        ? function (R) {
                ...
                this._compareValues = function (o, n, t, F, T) {
                    ...
                    if (t !== null) {
                        switch (ca) {
                            ...
                            case "date":
                            case "datetime":
                                D = String(b.jgrid.parseDate(T.newfmt ||
                                                             "Y-m-d", D).getTime());
                                J =
                                'jQuery.jgrid.parseDate("' + T.srcfmt + '",' + J + ").getTime()";
                                break;
                            default:
                                J = c._getStr(J);
                ...
                this.startsWith = function (o, n) {
                    ...
                    if (V) {
                        c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + o + "')")
                                      + ".substr(0," + t + ") == " + c._getStr('"' + c._toStr(n)
                                                                                   + '"'));
                    } else {
                        t =
                        l ? b.trim(n.toString()).length : n.toString().length;
                        c._append(c._getStr("this") + ".substr(0," + t + ") == " + c._getStr('"' + c
                            ._toStr(o) + '"'))
                    }
                ...
                this.endsWith = function (o, n) {
                    var t = n === undefined || n === null ? o : n;
                    t = l ? b.trim(t.toString()).length : t.toString().length;
                    V ? c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + o + "')")
                                      + ".substr(" + c._getStr("jQuery.jgrid.getAccessor(this,'" + o
                                                                   + "')") + ".length-" + t + ","
                                      + t + ') == "' + c._toStr(n) + '"') : c._append(c
                                                                                          ._getStr("this")
                                                                                          +
                                                                                      ".substr(" + c
                                                                                          ._getStr("this")
                ...
                this.contains = function (o, n) {
                    V ? c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + o + "')")
                                      + '.indexOf("' + c._toStr(n) + '",0) > -1') : c._append(c
                                                                                                  ._getStr("this")
                                                                                                  + '.indexOf("'
                                                                                                  + c
                                                                                                  ._toStr(o)
    ...
    b.fn.jqGrid = function (e) {
        ...
        return this.each(function () {
            if (!this.grid) {
                var c = b.extend(true,
                                 {url: "", height: 150, page: 1, rowNum: 20, rowTotal: null, records: 0, pager: "", pgbuttons: true, pginput: true, colModel:
                                     [], rowList: [], colNames: [
                                 ], sortorder: "asc", sortname: "", datatype: "xml", mtype: "GET", altRows: false, selarrrow:
                                     [], savedRow: [
                                 ], shrinkToFit: true, xmlReader: {}, jsonReader: {}, subGrid: false, subGridModel:
                                     [
                                     ], reccount: 0, lastpage: 0, lastsort: 0, selrow: null, beforeSelectRow: null, onSelectRow: null,
                                     ...
                                     rows: "rows", sort: "sidx", order: "sord", search: "_search", nd: "nd", id: "id", oper: "oper", editoper: "edit", addoper: "add", deloper: "del", subgridid: "id", npage: null, totalrows: "totalrows"}, forceFit: false, gridstate: "visible", cellEdit: false, cellsubmit: "remote", nv: 0, loadui: "enable", toolbar:
                                     [false, ""
                                     ], scroll: false, multiboxonly: false, deselectAfterSort: true, scrollrows: false, autowidth: false, scrollOffset: 18, cellLayout: 5, subGridWidth: 20, multiselectWidth: 20, gridview: false, rownumWidth: 25, rownumbers: false, pagerpos: "center",
                                     recordpos: "right", footerrow: false, userDataOnFooter: false, hoverrows: true, altclass: "ui-priority-secondary", viewsortcols:
                                     [false, "vertical", true
                                     ], resizeclass: "", autoencode: false, remapColumns: [
                                 ], ajaxGridOptions: {}, direction: "ltr", toppager: false, headertitles: false, scrollTimeout: 40, data:
                                     [], _index: {}, grouping: false, groupingView: {groupField: [
                                 ], groupOrder: [], groupText: [], groupColumnShow: [
                                 ], groupSummary: [], showSummaryOnHide: false, sortitems: [
                                 ], sortnames: [], groupDataSorted: false, summary: [], summaryval:
                                     [], plusicon: "ui-icon-circlesmall-plus",
                                     minusicon: "ui-icon-circlesmall-minus"}, ignoreCase: false, cmTemplate: {}, idPrefix: ""},
                                 b.jgrid.defaults, e || {}), h = {headers: [], cols: [], footers: [
                    ...
                    if (this.resizing) {
                        ...
                        if (j > 33) {
                            ...
                            if (c.forceFit === true) {
                                ...
                                this.newWidth =
                                c.direction === "ltr" ? c.tblwidth + f : c.tblwidth - f;
                                d.newWidth = j
                            }
                        }
                    }
                    ...
                    populateVisible: function () {
                        ...
                        if (d) {
                            ...
                            if (f[0].rows.length) {
                                try {
                                    m =
                                    (j = f[0].rows[1]) ? b(j).outerHeight() || h.prevRowHeight : h
                                        .prevRowHeight
                                } catch (p) {
                                    m = h.prevRowHeight
                                }
                            ...
                            if (m) {
                                ...
                                m *= C;
                                var z, u, w;
                                if (A < d && s <= 0 && (c.lastpage === undefined || parseInt((A + j
                                                                                                  + m
                                    - 1) / m, 10) <= c.lastpage)) {
                                ...
                                if (u) {
                                    if (!(c.lastpage && z > c.lastpage || c.lastpage == 1 || z
                                                                                                 === c
                                                                                                 .page
                                        && z === c.lastpage)) {
                                        if (h.hDiv.loading) {
                        ...
                        var f = d.p, j = f.selrow, m = f.selarrrow ? b.makeArray(f.selarrrow)
                            : null, p = d.grid.bDiv.scrollLeft, C = f.gridComplete;
                        f.gridComplete = function () {
                            ...
                            if (f.multiselect && m && m.length > 0) {
                                for (var s = 0; s < m.length;
                                     s++) {
                                    m[s] != j && b(d)
                                        .jqGrid("setSelection", m[s], false);
                                }
                            }
                            j &&
                            b(d).jqGrid("setSelection", j, false);
                ...
                if (this.tagName.toUpperCase() != "TABLE")alert("Element is not a table"); else {
                    ...
                    if (this.p.colNames.length === 0) {
                        for (k = 0; k < this.p.colModel.length;
                             k++) {
                            this.p.colNames[k] =
                            this.p.colModel[k].label || this.p
                                .colModel[k].name;
                        }
                    }
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors
                                                                                    .model); else {
                        var q = b("<div class='ui-jqgrid-view'></div>"),
                            x, y = b.browser.msie ? true : false, E = b.browser.webkit || b.browser
                                .safari ? true : false;
                        a = this;
                        ...
                        x =
                        y && b.browser.version <= 6
                            ? '<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>'
                            :
                        "";
                        b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id
                              + "'></div>").append(x).insertBefore(q);
                        b("<div class='loading ui-state-default ui-state-active' id='load_" + this
                            .id + "'>" + this.p.loadtext + "</div>").insertBefore(q);
                        b(this)
                        ...
                        var M = function (d, f) {
                            ...
                            var s = a.p.colModel[d], A = s.align, z = 'style="',
                            ...
                            f = o(d, f, j, p, "add");
                            return'<td role="gridcell" ' + N(j, m, f, p, d, true) + ">" + f
                                + "</td>"
                        }, t = function (d, f, j) {
                            var m = '<input role="checkbox" type="checkbox" id="jqg_' + a.p.id + "_"
                                        + d + '" class="cbox" name="jqg_' + a.p.id + "_" + d
                                + '"/>';
                            return'<td role="gridcell" ' + N(f, j, "", null, d, true) + ">" + m
                                + "</td>"
                        }, F = function (d, f, j, m) {
                            ...
                            for (p = 0; p < a.p.colModel.length; p++) {
                                ...
                                if (f.name !== "cb" && f.name !== "subgrid" && f.name !== "rn") {
                                    j[m] =
                                    d == "local" ? f.name : d == "xml" || d === "xmlstring" ? f
                                                                                                  .xmlmap
                            ...
                            if (f && a.p.scroll) {
                                b(">div:first", d).css({height: "auto"}).children("div:first")
                            ...
                            f =
                            a.p.keyIndex === false || a.p.loadonce === true ? a.p.localReader.id :
                            ...
                            var C = new Date, s = a.p.datatype != "local" && a.p.loadonce || a.p
                                                                                                 .datatype
                                == "xmlstring", A = a.p.xmlReader, z = a.p.datatype == "local"
                                ? "local" : "xml";
                            if (s) {
                                a.p.data = [];
                                a.p._index = {};
                            ...
                            if (b.isXMLDoc(d)) {
                                ...
                                var u, w, r = 0, G, O = 0, S = 0, K = 0, L, Z = [
                                ], P, v = {}, B, H, U = [], ia = a.p.altRows === true ? " " +
                                                                                        a.p.altclass
                                    : "";
                                A.repeatitems || (Z = T(z));
                                ...
                                if (b.isFunction(A.userdata)) {
                                    ...
                                    b
                                        .jgrid.getXmlData(d, A.userdata, true).each(function () {
                                                                                        a.p
                                                                                            .userData[this
                                                                                            .getAttribute("name")] =
                                                                                        b(this)
                                    ...
                                    for (; W < $;) {
                                        ...
                                        if (a.p.grouping) {
                                            ...
                                            for (var Da = [], za = 0; za < u; za++) {
                                                Da.push(v[a.p
                                                    .groupingView.groupField[za]]);
                                            }
                                            ha = b(a).jqGrid("groupingPrepare", U, Da,
                                                             ha, v);
                                            U = []
                                        }
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        a.p.treeGrid === true && w > 0 ? b(a.rows[w]).after(U
                                                                                                .join(""))
                                            : b("tbody:first", f).append(U.join(""))
                                    }
                                }
                                ...
                                a.p.reccount = r;
                                a.p.treeANode = -1;
                                a.p.userDataOnFooter && b(a).jqGrid("footerData", "set",
                                                                    a.p.userData, true);
                                if (s) {
                                    a.p.records = $;
                            ...
                            if (d) {
                                ...
                                var s, A = a.p.datatype != "local" && a.p.loadonce || a.p.datatype
                                    == "jsonstring";
                                if (A) {
                                    a.p.data = [];
                                    a.p._index = {};
                                ...
                                var z = 0, u, w, r = [
                                ], G, O = 0, S = 0, K = 0, L, Z, P = {}, v, B, H = [], U = a.p
                                                                                               .altRows
                                                                                               === true
                                    ? " " + a.p.altclass : "";
                                ...
                                var ia = parseInt(a.p.rowNum, 10), $ = a.p.scroll ? b.jgrid.randId()
                                    : 1;
                                if (p) {
                                    ia *= p + 1;
                                }
                                ...
                                for (; d < L;) {
                                    ...
                                    if (a.p.gridview === false) {
                                        b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(H
                                                                                                  .join(""));
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        a.p
                                            ...
                                            && v
                                            > 0
                                            ? b(a.rows[v]).after(H.join("")) : b("#" + b.jgrid
                                            .jqID(a.p
                                                      .id)
                                                                                     + " tbody:first")
                                            .append(H
                            ...
                            function d(v) {
                                ...
                                if (v.groups !== undefined) {
                                    (U =
                                     v.groups.length && v.groupOp.toString().toUpperCase() === "OR")
                                    && r.orBegin();
                                ...
                                if (v.rules !== undefined) {
                                    ...
                                    try {
                                        (ia =
                                         v.rules.length && v.groupOp.toString().toUpperCase()
                                             === "OR") &&
                                        r.orBegin();
                            ...
                            if (b.isArray(a.p.data)) {
                                ...
                                b.each(a.p.colModel, function () {
                                    ...
                                    if (A == "date" || A == "datetime") {
                                        if (this.formatter && typeof this.formatter === "string"
                                            ...
                                            s = this.formatoptions &&
                                                this.formatoptions.srcformat ? this.formatoptions
                                                    .srcformat : b.jgrid.formatter.date.srcformat;
                                            z =
                                            this.formatoptions && this.formatoptions.newformat
                                                ? this.formatoptions.newformat : b.jgrid.formatter
                                                .date.newformat
                                        } else {
                                    ...
                                    if (!j && (this.index == a.p.sortname || this.name == a.p
                                        .sortname)) {
                                        f =
                                        this.name;
                                        j = true
                                ...
                                if (a.p.treeGrid) {
                                    ...
                                    var w = {eq: function (v) {
                                        ...
                                        return B === "OR" ? v.orNot().startsWith :
                                               v.andNot().startsWith
                                    }, en: function (v, B) {
                                    ...
                                    if (a.p.search === true) {
                                        ...
                                        if (G) {
                                            ...
                                            try {
                                                r =
                                                w[a.p.postData.searchOper](r)(a.p.postData
                                                                                  .searchField,
                                                                              a.p.postData
                                                                                  .searchString,
                                                                              m[a.p.postData
                                    ...
                                    if (f && a.p.sortorder && j) {
                                        a.p.sortorder.toUpperCase()
                                            == "DESC" ? r.orderBy(a.p
                                                                      .sortname,
                                                                  "d", m[f]
                                                .stype, m[f].srcfmt) : r.orderBy(a.p.sortname, "a",
                                                                                 m[f].stype,
                                                                                 m[f].srcfmt);
                                    }
                                    G = r.select();
                                    var S = parseInt(a.p.rowNum, 10), K = G.length, L = parseInt(a.p
                                                                                                     .page,
                                                                                                 10), Z = Math
                                        .ceil(K / S), P = {};
                                    G = G.slice((L - 1) * S, L * S);
                            ...
                            if (!a.grid.hDiv.loading) {
                                ...
                                var z = !a.p.scroll ? 1 : a.rows.length -
                                                          1;
                                if (b.isFunction(a.p.datatype)) {
                                    ...
                                    switch (m) {
                                        ...
                                        case "xml":
                                        case "script":
                                            b.ajax(b.extend({url: a.p.url, type: a.p
                                                .mtype, dataType: m, data: b.isFunction(a.p
                                                                                            .serializeGridData)
                                                ? a.p.serializeGridData.call(a, a.p.postData) : a.p
                                                                               .postData, success: function (u,
                                                                                                             w,
                                                                                                             r) {
                                                b.isFunction(a.p.beforeProcessing) && a.p
                                                    .beforeProcessing.call(a,
                                                                           u, w, r);
                                                m === "xml" ? X(u, a.grid.bDiv, z, d > 1, A) : fa(u,
                                                                                                  a
                                                                                                      .grid
                                                                                                      .bDiv,
                                                                                                  z,
                                        ...
                                        case "jsonstring":
                                            R();
                                            j =
                                            typeof a.p.datastr == "string" ? b.jgrid.parse(a.p
                                                                                               .datastr)
                                                : a.p.datastr;
                                            fa(j, a.grid.bDiv);
                                            s && a.p.loadComplete.call(a, j);
                            ...
                            b("#cb_" + b.jgrid.jqID(a.p.id),
                              a.grid.hDiv)[a.p.useProp ? "prop" : "attr"]("checked", d);
                            if (a.p.frozenColumns && a.p.id + "_frozen") {
                                b("#cb_" + b.jgrid.jqID(a.p
                                                            .id),
                                  a.grid.fhDiv)[a.p.useProp
                                    ? "prop" : "attr"]("checked", d)
                            }
                        };
                        x = function (d, f) {
                            ...
                            A = d + "_center";
                            z = d + "_right";
                            b("#" + b.jgrid.jqID(d)).append("<div id='" + C
                            ...
                            m += "</tr></tbody></table>";
                            a.p.viewrecords === true && b("td#" + d + "_" + a.p.recordpos, "#" + C)
                                .append("<div dir='" + l + "' style='text-align:" + a.p.recordpos
                            ...
                            a.p._nvtd = [];
                            a.p._nvtd[0] =
                            m ? Math.floor((a.p.width - m) / 2) : Math.floor(a.p.width / 3);
                            a.p._nvtd[1] = 0;
                            m = null;
                            b(".ui-pg-selbox", "#" + C).bind("change", function () {
                                a.p.page =
                                Math.round(a.p.rowNum * (a.p.page - 1) / this.value - 0.5) + 1;
                                a.p.rowNum =
                                this.value;
                                if (f) {
                            ...
                            if (a.p.pgbuttons === true) {
                                ...
                                b("#first" + b.jgrid.jqID(f) + ", #prev" + b.jgrid.jqID(f)
                                      + ", #next" + b.jgrid.jqID(f) + ", #last" + b.jgrid.jqID(f))
                                    .click(function () {
                            ...
                            a.p.pginput === true && b("input.ui-pg-input", "#" + C)
                                .keypress(function (w) {
                        ...
                        var Ea = function (d, f, j, m) {
                            if (a.p.colModel[f].sortable) {
                                if (!(a.p.savedRow.length > 0)) {
                                    ...
                                    if (m) {
                                        if (a.p.lastsort == f && a.p.sortorder == m
                                            && !j) {
                                            return;
                                        } else {
                                            a.p.sortorder = m;
                            ...
                            for (f = j[0] = j[1] = j[2] = 0; f <= d; f++)if (a.p.colModel[f].hidden
                                === false)j[0] += a.p.colModel[f].width + m;
                            if (a.p.direction == "rtl")j[0] = a.p.width - j[0];
                            j[0] -= a.grid.bDiv.scrollLeft;
                            if (b(a.grid.cDiv).is(":visible"))j[1] +=
                                                              b(a.grid.cDiv).height() + parseInt(b(a
                                                                                                       .grid
                                                                                                       .cDiv)
                                                                                                     .css("padding-top"),
                                                                                                 10)
                                                                  + parseInt(b(a.grid.cDiv)
                                                                                 .css("padding-bottom"),
                                                                             10);
                            if (a.p.toolbar[0] === true && (a.p.toolbar[1] == "top" || a.p
                                                                                           .toolbar[1]
                                ==
                                                                                       "both"))j[1] +=
                                                                                               b(a
                                                                                                   ...
                                                                                                   + parseInt(b(a
                                                                                                              ...
                                                                                                              10);
                            if (a.p.toppager)j[1] +=
                                             b(a.grid.topDiv).height() + parseInt(b(a.grid.topDiv)
                                                                                      .css("border-bottom-width"),
                                                                                  10);
                            ...
                            for (f = 0; f < j.length; f++)if (d === j[f].el) {
                                m = f;
                                break
                            }
                            return m
                        ...
                        for (k = 0; k < a.p.colModel.length; k++) {
                            a.p.colModel[k] =
                            b.extend(true, {}, a.p.cmTemplate, a.p.colModel[k].template || {},
                                     a.p.colModel[k]);
                            if (a.p.keyIndex === false && a.p.colModel[k].key === true)a.p
                                                                                           .keyIndex =
                                                                                       k
                        }
                        ...
                        if (this.p.multiselect) {
                            ...
                            this.p.colModel.unshift({name: "cb", width: E ? a.p.multiselectWidth + a
                                .p.cellLayout : a.p
                                                                            .multiselectWidth, sortable: false, resizable: false, hidedlg: true, search: false, align: "center", fixed: true})
                        }
                        if (this.p.rownumbers) {
                            this.p.colNames.unshift("");
                            this.p.colModel.unshift({name: "rn", width: a.p
                                .rownumWidth, sortable: false,
                                                        resizable: false, hidedlg: true, search: false, align: "center", fixed: true})
                        }
                        a.p.xmlReader =
                        b.extend(true,
                                 {root: "rows", row: "row", page: "rows>page", total: "rows>total", records: "rows>records", repeatitems: true, cell: "cell", id: "[id]", userdata: "userdata", subgrid: {root: "rows", row: "row", repeatitems: true, cell: "cell"}},
                                 a.p.xmlReader);
                        a.p.jsonReader =
                        b.extend(true,
                                 {root: "rows", page: "page", total: "total", records: "records", repeatitems: true, cell: "cell", id: "id", userdata: "userdata", subgrid: {root: "rows", repeatitems: true, cell: "cell"}},
                                 a.p.jsonReader);
                        a.p.localReader =
                        b.extend(true,
                                 {root: "rows", page: "page", total: "total", records: "records", repeatitems: false, cell: "cell", id: "id", userdata: "userdata", subgrid: {root: "rows", repeatitems: true, cell: "cell"}},
                                 a.p.localReader);
                        if (a.p.scroll) {
                            a.p.pgbuttons = false;
                            a.p.pginput = false;
                        ...
                        na = oa = "";
                        if (a.p.shrinkToFit === true && a.p.forceFit === true)for (k =
                                                                                   a.p.colModel
                                                                                       .length - 1;
                                                                                   k >= 0;
                                                                                   k--)if (!a.p
                        ...
                        "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"
                            + oa + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + l
                            + "'></span>";
                        oa +=
                        "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + na
                            + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + l
                            + "'></span></span>";
                        for (k = 0; k < this.p.colNames.length; k++) {
                            na =
                            a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[k]) +
                                               '"' : "";
                            da +=
                            "<th id='" + a.p.id + "_" + a.p.colModel[k].name
                                + "' role='columnheader' class='ui-state-default ui-th-column ui-th-"
                                + l + "'" + na + ">";
                            na = a.p.colModel[k].index || a.p.colModel[k].name;
                            da +=
                            "<div id='jqgh_" + a.p.id + "_" + a.p.colModel[k].name + "' " + Ga + ">"
                                + a.p.colNames[k];
                            a.p.colModel[k].width =
                            a.p.colModel[k].width ? parseInt(a.p.colModel[k].width, 10) : 150;
                            if (typeof a.p.colModel[k].title !== "boolean")a.p.colModel[k].title =
                                                                           true;
                            ...
                            b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function () {
                                ...
                                if (this.checked) {
                                    b(a.rows).each(function (f) {
                                        if (f > 0)if (!b(this).hasClass("ui-subgrid") && !b(this)
                                            .hasClass("jqgroup") && !b(this)
                                            .hasClass("ui-state-disabled")) {
                                            b("#jqg_" + b.jgrid.jqID(a.p.id) +
                                              "_" + b.jgrid.jqID(this.id))[a.p.useProp ? "prop"
                                                : "attr"]("checked", true);
                                            ...
                                            a.p.selrow = this.id;
                                            if (d) {
                                                b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid
                                                    .jqID(this.id), a.grid.fbDiv)[a.p.useProp
                                                    ? "prop" : "attr"]("checked", true);
                                                b("#" + b.jgrid.jqID(this.id), a.grid.fbDiv)
                                    ...
                                    b(a.rows).each(function (f) {
                                        if (f > 0)if (!b(this).hasClass("ui-subgrid") && !b(this)
                                            .hasClass("ui-state-disabled")) {
                                            b("#jqg_" +
                                              b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(this.id))[a
                                                                                                      .p
                                                                                                      .useProp
                                ...
                                if (b.isFunction(a.p.onSelectAll))a.p.onSelectAll.call(a, va ? a.p
                                    .selarrrow : Aa, va)
                            })
                        }
                        if (a.p.autowidth ===
                        ...
                        (function () {
                            var d = 0, f = E ? 0 : a.p.cellLayout, j = 0, m, p = a.p
                                .scrollOffset, C, s = false, A, z = 0, u = 0, w;
                            b.each(a.p.colModel, function () {
                            ...
                            if (isNaN(a.p.width))a.p.width = h.width = d; else h.width = a.p.width;
                            a.p.tblwidth = d;
                            if (a.p.shrinkToFit === false && a.p.forceFit === true)a.p.forceFit =
                                                                                   false;
                            if (a.p.shrinkToFit === true && j > 0) {
                                ...
                                b.each(a.p.colModel, function (r) {
                                    if (this.hidden === false && !this.fixed) {
                                        this.width =
                                        C = Math.round(A * this.width / (a.p.tblwidth - f * j - z));
                                        d += C;
                                        m = r
                                    }
                                });
                                w = 0;
                                if (s) {
                                    if (h.width - z - (d + f * j) !== p)w =
                                                                        h.width - z - (d + f * j)
                                                                            - p
                                } else if (!s && Math.abs(h.width - z - (d + f * j)) !== 1)w =
                                                                                           h.width
                                                                                               - z
                                                                                               - (d
                                                                                               + f
                        ...
                        b(I).css("width", h.width +
                                          "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"
                                                           + a.p.id + "'>&#160;</div>");
                        b(q).css("width", h.width + "px");
                        da = b("thead:first", a).get(0);
                        var wa = "";
                        if (a.p.footerrow)wa +=
                                          "<table role='grid' style='width:" + a.p.tblwidth
                        ...
                        b("th", q).each(function (d) {
                            ta =
                            a.p.colModel[d].width;
                            if (typeof a.p.colModel[d].resizable === "undefined")a.p.colModel[d]
                                                                                     .resizable =
                                                                                 true;
                            if (a.p.colModel[d].resizable) {
                                ra = document.createElement("span");
                                b(ra).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"
                                                                  + l);
                            ...
                            if (typeof ua !== "boolean")ua = a.p.colModel[d].sortable = true;
                            f = a.p.colModel[d].name;
                            f == "cb" || f == "subgrid" || f == "rn" || a.p.viewsortcols[2]
                                && b(">div", this).addClass("ui-jqgrid-sortable");
                            if (ua)if (a.p.viewsortcols[0]) {
                                b("div span.s-ico", this).show();
                                d == a.p.lastsort && b("div span.ui-icon-" + a.p.sortorder, this)
                                    .removeClass("ui-state-disabled")
                            ...
                            if (a.p.footerrow)wa +=
                                              "<td role='gridcell' " + N(d, 0, "", null, "", false)
                                                  + ">&#160;</td>"
                                         ...
                                         if (b(d.target).closest("th>span.ui-jqgrid-resize").length
                                             ...
                                             if (a.p.forceFit === true) {
                                                 var j = a.p, m = f, p;
                                                 for (p = f + 1; p < a.p.colModel.length; p++)if (a
                                                                                                      .p
                                                                                                      .colModel[p]
                                                                                                      .hidden
                                                     !== true) {
                        ...
                        xa = null;
                        q =
                        b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth
                              + "px' role='grid' aria-labelledby='gbox_" +
                          this.id + "' cellspacing='0' cellpadding='0' border='0'></table>")
                            .append(da);
                        var ea = a.p.caption && a.p.hiddengrid === true ? true : false;
                        k =
                        b("<div class='ui-jqgrid-hbox" + (l == "rtl" ? "-rtl" : "") + "'></div>");
                        da = null;
                        h.hDiv = document.createElement("div");
                        b(h.hDiv).css({width: h.width + "px"})
                        ...
                        if (a.p.pager) {
                            ...
                            b(a.p.pager).css({width: h.width + "px"}).appendTo(I)
                        ...
                        b(a).before(h.hDiv).click(function (d) {
                            ...
                            if (b(Q).length === 0 || Q[0].className.indexOf("ui-state-disabled")
                                > -1 || b(Y, a).closest("table.ui-jqgrid-btable")[0].id
                                            .replace("_frozen", "") !== a.id)return this;
                            var f = b(Y).hasClass("cbox"), j = true;
                            if (b.isFunction(a.p.beforeSelectRow))j =
                                                                  a.p.beforeSelectRow.call(a,
                                                                                           Q[0].id,
                                                                                           d);
                            if (Y.tagName == "A" || (Y.tagName == "INPUT" || Y.tagName == "TEXTAREA"
                                                         || Y.tagName == "OPTION" || Y.tagName
                                                         == "SELECT") && !f)return this;
                            if (j === true) {
                                if (a.p.cellEdit === true)if (a.p.multiselect && f)b(a)
                                    .jqGrid("setSelection", Q[0].id, true); else {
                                    la = Q[0].rowIndex;
                                ...
                                } else if (a.p.multikey)if (d[a.p.multikey])b(a)
                                    .jqGrid("setSelection", Q[0].id, true); else {
                                    if (a.p.multiselect && f) {
                                        f =
                                        b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + Q[0].id)
                                            .is(":checked");
                                        b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + Q[0].id)[a.p
                                                                                              .useProp
                                            ? "prop" : "attr"]("checked", f)
                                    }
                                } else {
                                    if (a.p.multiselect && a.p.multiboxonly)if (!f) {
                                        ...
                                        b(a.p.selarrrow).each(function (C, s) {
                                            ...
                                            b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid
                                                .jqID(s))[a.p.useProp ? "prop" : "attr"]("checked",
                                                                                         false);
                                            if (p) {
                                                b("#" + b.jgrid.jqID(s), "#" + b.jgrid.jqID(p))
                                                    .removeClass("ui-state-highlight");
                                                b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid
                                                    .jqID(s), "#" + b.jgrid.jqID(p))[a.p.useProp
                                                    ? "prop" : "attr"]("checked", false)
                                            }
                                        });
                                        a.p.selarrrow = []
                            ...
                            return this
                                ...
                                function (d, f) {
                                    ...
                                    if (f && f.page) {
                                        ...
                                        a.p.page = j;
                                        a.grid.bDiv.scrollTop =
                                        a.grid.prevRowHeight ? (j - 1) * a.grid.prevRowHeight * a.p
                                            .rowNum : 0
                                    }
                        ...
                        b(h.bDiv).append(b('<div style="position:relative;' + (y && b.browser
                                                                                        .version < 8
                                ? "height:0.01%;" : "") + '"></div>').append("<div></div>")
                                             .append(this)).addClass("ui-jqgrid-bdiv")
                            .css({height: a.p.height + (isNaN(a.p.height) ? "" : "px"), width: h
                                                                                                   .width
                            +
                                                                                               "px"})
                            .scroll(h.scrollGrid);
                        ...
                        b(h.cDiv).append(Ba).append("<span class='ui-jqgrid-title" + (l == "rtl"
                            ? "-rtl" : "") + "'>" + a.p.caption + "</span>")
                            .addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");
                        b(h.cDiv).insertBefore(h.hDiv);
                        if (a.p.toolbar[0]) {
                            h.uDiv = document.createElement("div");
                            if (a.p.toolbar[1] == "top")b(h.uDiv).insertBefore(h.hDiv); else a.p
                                                                                                 .toolbar[1]
                                                                                                 ==
                                                                                             "bottom"
                            ...
                            if (a.p.toolbar[1] == "both") {
                                ...
                                b(h.uDiv).insertBefore(h.hDiv)
                                    .addClass("ui-userdata ui-state-default").attr("id",
                                                                                   "t_" + this.id);
                                b(h.ubDiv).insertAfter(h.hDiv)
                                    .addClass("ui-userdata ui-state-default").attr("id",
                                                                                   "tb_" + this.id);
                                ea && b(h.ubDiv).hide()
                            } else b(h.uDiv).width(h.width).addClass("ui-userdata ui-state-default")
                                .attr("id", "t_" + this.id);
                            ea && b(h.uDiv).hide()
                        }
                        if (a.p.toppager) {
                            ...
                            b(h.topDiv).insertBefore(h.hDiv)
                                .addClass("ui-state-default ui-jqgrid-toppager").width(h.width);
                            x(a.p.toppager, "_t")
                        }
                        if (a.p.footerrow) {
                            h.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0];
                            k =
                            b("<div class='ui-jqgrid-hbox" + (l == "rtl" ? "-rtl" : "")
                                  + "'></div>");
                            b(h.sDiv).append(k).insertAfter(h.hDiv).width(h.width);
                            b(k).append(wa);
                            h.footers = b(".ui-jqgrid-ftable", h.sDiv)[0].rows[0].cells;
                            if (a.p.rownumbers)h.footers[0].className =
                        ...
                        if (a.p.caption) {
                            ...
                            if (a.p.hidegrid === true) {
                                b(".ui-jqgrid-titlebar-close", h.cDiv).click(function (d) {
                                    var f = b.isFunction(a.p
                                                             .onHeaderClick), j = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", m, p = this;
                                    if (a.p.toolbar[0] === true) {
                                        if (a.p.toolbar[1] == "both")j +=
                                                                     ", #" + b(h.ubDiv).attr("id");
                                        j += ", #" + b(h.uDiv).attr("id")
                                    }
                                    m = b(j, "#gview_" + b.jgrid.jqID(a.p.id)).length;
                                    if (a.p.gridstate == "visible")b(j, "#gbox_" + b.jgrid.jqID(a.p
                                                                                                    .id))
                                        .slideUp("fast", function () {
                                        m--;
                                        if (m === 0) {
                                            b("span", p).removeClass("ui-icon-circle-triangle-n")
                                                .addClass("ui-icon-circle-triangle-s");
                                            a.p.gridstate = "hidden";
                                            b("#gbox_" + b.jgrid.jqID(a.p.id))
                                                .hasClass("ui-resizable")
                                            && b(".ui-resizable-handle",
                                                 "#gbox_" + b.jgrid.jqID(a.p.id)).hide();
                                            if (f)ea || a.p.onHeaderClick.call(a, a.p.gridstate, d)
                                        }
                                    }); else a.p.gridstate == "hidden" && b(j, "#gbox_" + b.jgrid
                                        .jqID(a.p.id)).slideDown("fast", function () {
                                        m--;
                                        if (m === 0) {
                                            b("span", p).removeClass("ui-icon-circle-triangle-s")
                                            ...
                                            b("#gbox_" + b.jgrid.jqID(a.p.id))
                                                .hasClass("ui-resizable")
                                            && b(".ui-resizable-handle",
                                                 "#gbox_" + b.jgrid.jqID(a.p.id)).show();
                                            if (f)ea || a.p.onHeaderClick.call(a, a.p.gridstate, d)
                                        }
                                    });
                                    return false
                        ...
                        a.updatepager = function (d, f) {
                            var j, m, p, C, s, A, z, u = "", w = a.p.pager ? "_" + b.jgrid.jqID(a.p
                                                                                                    .pager
                                                                                                    .substr(1))
                            ...
                            if (a.p.scroll) {
                                ...
                                if (m = j.outerHeight() || a.grid.prevRowHeight) {
                                    ...
                                    m *= parseInt(a.p.records,
                                                  10);
                                    b(">div:first", a.grid.bDiv).css({height: m})
                                        .children("div:first").css({height: j, display: j ? ""
                                        : "none"})
                                }
                            ...
                            if (u) {
                                ...
                                j = M(a.p.page);
                                m = M(a.p.lastpage);
                                b(".selbox", u)[this.p.useProp ? "prop" : "attr"]("disabled",
                                                                                  false);
                                if (a.p.pginput === true) {
                                ...
                                if (a.p.viewrecords)if (a.p.reccount === 0)b(".ui-paging-info", u)
                                    .html(a.p.emptyrecords); else {
                                    C = p + 1;
                                    A = a.p.records;
                                    if (b.fmatter) {
                                    ...
                                    b(".ui-paging-info", u).html(b.jgrid.format(a.p.recordtext, C,
                                                                                s, A))
                                }
                                if (a.p.pgbuttons === true) {
                                    if (j <= 0)j = m = 0;
                                    if (j == 1 || j === 0) {
                                        ...
                                        a.p.toppager && b("#first_t" + r + ", #prev_t" + r)
                                            .addClass("ui-state-disabled")
                                            .removeClass("ui-state-hover")
                                    } else {
                                        b("#first" +
                                    ...
                                    if (j == m || j === 0) {
                                        b("#next" + w + ", #last" + w).addClass("ui-state-disabled")
                                            .removeClass("ui-state-hover");
                                        a.p.toppager && b("#next_t" + r + ", #last_t" + r)
                                            .addClass("ui-state-disabled")
                                            .removeClass("ui-state-hover")
                                    } else {
                                        b("#next" + w + ", #last" + w)
    ...
    b.jgrid.extend({getGridParam: function (e) {
        var i = this[0];
        if (i && i.grid)return e ? typeof i.p[e] != "undefined" ? i.p[e] : null : i.p
        ...
        return this.each(function () {
            function g(x) {
                var y =
                    b(c.grid.bDiv)[0].clientHeight, E = b(c.grid.bDiv)[0].scrollTop, I = c.rows[x]
                    .offsetTop;
                x = c.rows[x].clientHeight;
                if (I + x >= y + E)b(c.grid.bDiv)[0].scrollTop = I - (y + E) + x + E; else if (I < y
                    + E)if (I < E)b(c.grid.bDiv)[0].scrollTop = I
            }
            ...
            if (e !== undefined) {
                ...
                if (!(!k || !k.className || k.className.indexOf("ui-state-disabled") > -1)) {
                    ...
                    if (c.p.multiselect) {
                        ...
                        if (l === -1) {
                            k.className !== "ui-subgrid" && b(k).addClass("ui-state-highlight")
                                .attr("aria-selected", "true");
                            h = true;
                            c.p.selarrrow.push(c.p.selrow)
                        } else {
                            k.className !== "ui-subgrid" && b(k).removeClass("ui-state-highlight")
                                .attr("aria-selected", "false");
                            h = false;
                        ...
                        b("#jqg_" + b.jgrid.jqID(c.p.id) + "_" + b.jgrid.jqID(c.p.selrow))[c.p
                                                                                               .useProp
                            ? "prop" : "attr"]("checked", h);
                        if (q) {
                            l === -1 ? b("#" +
                                         b.jgrid.jqID(e), "#" + b.jgrid.jqID(q))
                                .addClass("ui-state-highlight") : b("#" + b.jgrid.jqID(e),
                                                                    "#" + b.jgrid.jqID(q))
                                .removeClass("ui-state-highlight");
                            b("#jqg_" + b.jgrid.jqID(c.p.id) + "_" + b.jgrid.jqID(e),
                              "#" + b.jgrid.jqID(q))[c.p.useProp ? "prop" : "attr"]("checked", h)
                        }
                        c.p.onSelectRow && i && c.p.onSelectRow.call(c, k.id, h)
                    } else if (k.className !== "ui-subgrid") {
                        if (c.p.selrow != k.id) {
                            b(c.rows.namedItem(c.p.selrow)).removeClass("ui-state-highlight")
                                .attr({"aria-selected": "false", tabindex: "-1"});
                            b(k).addClass("ui-state-highlight").attr({"aria-selected": "true",
                                                                         tabindex: "0"});
                            if (q) {
                                b("#" + b.jgrid.jqID(c.p.selrow), "#" + b.jgrid.jqID(q))
                                    .removeClass("ui-state-highlight");
                                b("#" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(q))
                                    .addClass("ui-state-highlight")
                            }
                            h = true
                        } else h = false;
        ...
        return this.each(function () {
            ...
            if (typeof e !== "undefined") {
                ...
                b("#" + b.jgrid.jqID(i.p.id) + " tbody:first tr#" + b.jgrid.jqID(c))
                    .removeClass("ui-state-highlight").attr("aria-selected",
                                                            "false");
                if (i.p.multiselect) {
                    b("#jqg_" + b.jgrid.jqID(i.p.id) + "_" + b.jgrid.jqID(c))[i.p.useProp ? "prop"
                        : "attr"]("checked", false);
                ...
                b(i.p.selarrrow).each(function (h, k) {
                    ...
                    b("#jqg_" + b.jgrid.jqID(i.p.id) + "_" + b.jgrid.jqID(k))[i.p.useProp ? "prop"
                        : "attr"]("checked", false)
                });
                i.setHeadCheckBox(false);
                i.p.selarrrow = []
                ...
                b("#" + b.jgrid.jqID(i.p.id) + " tbody:first tr#" +
                  b.jgrid.jqID(i.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected",
                                                                                   "false");
                i.p.selrow = null
            }
            if (i.p.cellEdit === true)if (parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10)
                >= 0) {
            ...
            for (; k < h;) {
                ...
                if (b(q).hasClass("jqgrow")) {
                    b("td", q).each(function (x) {
                        ...
                        if (a !== "cb" && a !== "subgrid" && a !== "rn")if (l.p.treeGrid === true
                            && a == l.p.ExpandColumn)i[a] =
                                                     b.jgrid.htmlDecode(b("span:first", this)
                                                                            .html()); else try {
        ...
        this.each(function () {
            if (g = this.rows.namedItem(e)) {
                ...
                if (e == this.p.selrow)this.p.selrow = null
            } else return false;
        ...
        this.each(function () {
            ...
            if (i)try {
                b(this.p.colModel).each(function (N) {
                    ...
                    if (i[c] !== undefined) {
                        y[c] =
                        this.formatter && typeof this.formatter === "string" && this.formatter
                            == "date" ? b.unformat.date(i[c], this) : i[c];
                        a = l.formatter(e, i[c], N, i, "edit");
                        k = this.title ? {title: b.jgrid.stripHtml(a)} : {};
                        l.p.treeGrid === true && c == l.p.ExpandColumn ? b("td:eq(" + N
                                                                               + ") > span:first",
                                                                           q).html(a).attr(k)
                            : b("td:eq(" +
                                N + ")", q).html(a).attr(k)
                ...
                if (l.p.datatype == "local") {
                    var E = l.p._index[e];
                    if (l.p.treeGrid)for (var I in l.p.treeReader)y.hasOwnProperty(l.p
                                                                                       .treeReader[I])
        ...
        if (i) {
            ...
            this.each(function () {
                ...
                if (!N)if (typeof e != "undefined")e += ""; else {
                    e = b.jgrid.randId();
                    if (this.p.keyIndex !== false) {
                        V = this.p.colModel[this.p.keyIndex + a + q + x].name;
                        if (typeof i[0][V] != "undefined")e = i[0][V]
                    }
                }
                o = this.p.altclass;
                for (var T = 0, J = "", D = {}, ca = b.isFunction(this.p.afterInsertRow) ? true
                    : false; T < F;) {
                    n = i[T];
                    l = "";
                    if (N) {
                        ...
                        J = this.p.altRows ===
                            true ? (this.rows.length - 1) % 2 === 0 ? o : "" : ""
                    }
                    e = this.p.idPrefix + e;
                    if (x) {
                        M = this.formatCol(0, 1, "", null, e, true);
                        l +=
                        '<td role="gridcell" aria-describedby="' + this.p.id
                            + '_rn" class="ui-state-default jqgrid-rownum" ' + M + ">0</td>"
                    }
                    if (a) {
                        I =
                        '<input role="checkbox" type="checkbox" id="jqg_' + this.p.id + "_" + e
                            + '" class="cbox"/>';
                        M = this.formatCol(x, 1, "", null, e, true);
                        l +=
                        '<td role="gridcell" aria-describedby="' + this.p.id + '_cb" ' + M + ">" + I
                            + "</td>"
                    }
                    ...
                    for (E = a + q + x; E < this.p.colModel.length; E++) {
                        ...
                        k = t.name;
                        D[k] =
                        t.formatter && typeof t.formatter === "string" && t.formatter == "date" ? b
                            .unformat.date(n[k], t) : n[k];
                        I = this.formatter(e, b.jgrid.getAccessor(n, k), E, n, "edit");
                        M = this.formatCol(E, 1, I, n, e, true);
                        l +=
                        '<td role="gridcell" aria-describedby="' + this.p.id + "_" + k + '" ' + M
                            + ">" + I + "</td>"
                    }
                    l =
                    '<tr id="' + e
                    ...
                    if (this.rows.length === 0)b("table:first", this.grid.bDiv)
                        .append(l); else switch (g) {
                        case "last":
                        ...
                        case "first":
                            ...
                            break;
                        case "after":
                            if (y = this.rows.namedItem(c))b(this.rows[y.rowIndex + 1])
                                                               .hasClass("ui-subgrid") ? b(this
                                                                                               .rows[y
                                                                                                         .rowIndex
                                + 1]).after(l) : b(y).after(l);
                            y++;
                            break;
                        case "before":
                ...
                if (this.p.altRows === true && !N)if (g == "last")(this.rows.length - 1) % 2 == 1
                && b(this.rows[this.rows.length - 1]).addClass(o); else b(this.rows)
                    .each(function (fa) {
        ...
        this.each(function () {
            ...
            b(this.p.colModel).each(function (y) {
                ...
                } else if (e == "get")l[h] = b("tr.footrow td:eq(" + y + ")", q.grid.sDiv).html()
            })
        });
        return e == "get" ? l : k
        ...
        return this.each(function () {
            ...
            if (g.grid) {
                ...
                i = i != "none" ? "" : "none";
                var l = i === "" ? true : false, a = g.p.groupHeader && (typeof g.p.groupHeader
                                                                             === "object" || b
                                                                             .isFunction(g.p
                                                                                             .groupHeader));
                ...
                b(this.p.colModel).each(function (q) {
                    if (b.inArray(this.name, e) !== -1 && this.hidden === l) {
                        ...
                        g.p.footerrow && b("tr.footrow td:eq(" + q + ")", g.grid.sDiv)
                            .css("display", i);
                ...
                if (c === true)b(g).jqGrid("setGridWidth",
                                           g.p.shrinkToFit === true ? g.p.tblwidth : g.p.width);
        ...
        i && h(b("#" + b.jgrid.jqID(k.p.id) + " tbody:first"),
               ".jqgfirstrow, tr.jqgrow, tr.jqfoot");
        k.p.footerrow &&
        h(b("tbody:first", k.grid.sDiv));
        if (k.p.remapColumns)if (k.p.remapColumns.length)c(k.p.remapColumns); else k.p
                                                                                       .remapColumns =
                                                                                   b.makeArray(e);
        k.p.lastsort = b.inArray(k.p.lastsort, e);
        if (k.p.treeGrid)k.p.expColInd = b.inArray(k.p.expColInd, e)
    }, setGridWidth: function (e, i) {
        return this.each(function () {
            if (this.grid) {
                var g = this, c, h = 0, k = b.browser.webkit || b.browser.safari ? 0 : g.p
                    .cellLayout, l, a = 0, q = false, x = g.p.scrollOffset, y, E = 0, I = 0, M;
                ...
                if (!isNaN(e)) {
                    ...
                    if (i === false && g.p.forceFit === true)g.p.forceFit =
                                                             false;
                    if (i === true) {
                        ...
                        g.p.tblwidth = h;
                        y = e - k * a - E;
                        if (!isNaN(g.p.height))if (b(g.grid.bDiv)[0].clientHeight < b(g.grid
                                                                                          .bDiv)[0]
                            .scrollHeight || g.rows.length === 1) {
                            q = true;
                            y -= x
                        }
                        h = 0;
                        ...
                        M = 0;
                        if (q) {
                            if (e - E - (h + k * a) !== x)M = e - E - (h + k * a) - x
                        } else if (Math.abs(e - E - (h + k * a)) !== 1)M = e - E - (h + k * a);
                    ...
                    if (g.p.tblwidth) {
                        ...
                        g.p.footerrow && b("table:first", g.grid.sDiv).css("width",
                                                                           g.p.tblwidth + "px")
                    }
                }
            }
        ...
        return this.each(function () {
            if (this.grid) {
                b(this.grid.bDiv).css({height: e + (isNaN(e) ?
                                                    "" : "px")});
                this.p.height = e;
        ...
        return this.each(function () {
            var h = -1;
            if (this.grid)if (typeof e != "undefined") {
        ...
        return this.each(function () {
            ...
            if (this.grid) {
                ...
                if (l >= 0)if (a = this.rows.namedItem(e)) {
                    var x = b("td:eq(" + l + ")", a);
                    if (g !== "" || k === true) {
                        a = this.formatter(e, g, l, a, "edit");
                        q = this.p.colModel[l].title ?
                            {title: b.jgrid.stripHtml(a)} : {};
                        this.p.treeGrid && b(".tree-wrap", b(x)).length > 0 ? b("span", b(x))
                            .html(a).attr(q) : b(x).html(a).attr(q);
                        if (this.p.datatype == "local") {
                            a = this.p.colModel[l];
                            g =
                            a.formatter && typeof a.formatter === "string" && a.formatter == "date"
                                ? b.unformat.date(g, a) : g;
                            q = this.p._index[e];
        ...
        this.each(function () {
            ...
            if (this.grid) {
                ...
                if (c >= 0) {
                    ...
                    if (h)try {
                        g =
                        b.unformat(b("td:eq(" + c + ")", h),
                                   {rowId: h.id, colModel: this.p.colModel[c]}, c)
                    } catch (k) {
        ...
        this.each(function () {
            var x = -1;
            if (this.grid) {
                if (isNaN(e))b(this.p.colModel).each(function (M) {
                    if (this.name ===
                        e) {
                        x = M;
                        return false
                    }
                }); else x = parseInt(e, 10);
                if (x >= 0) {
                    ...
                    if (y && y > 0) {
                        for (; E < y;) {
                            if (b(this.rows[E]).hasClass("jqgrow")) {
                                try {
                                    h =
                                    b.unformat(b(this.rows[E].cells[x]),
                                               {rowId: this.rows[E].id, colModel: this.p
                                                   .colModel[x]}, x)
                                } catch (I) {
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                if (this.p.deepempty)b("#" + b.jgrid.jqID(this.p.id) + " tbody:first tr:gt(0)")
                    .remove(); else {
        ...
        var g = false, c;
        this.each(function () {
            if (c = this.rows.namedItem(e))g = i === true ? c : c.rowIndex
        });
        return g
    }, bindKeys: function (e) {
        var i = b
            .extend({onEnter: null, onSpace: null, onLeftKey: null, onRightKey: null, scrollingRows: true},
                    e || {});
        return this.each(function () {
            var g = this;
            ...
            b(g).keydown(function (c) {
                ...
                if (h) {
                    a = g.p._index[h.id];
                    if (c.keyCode === 37 || c.keyCode === 38 || c.keyCode === 39 || c.keyCode
                        === 40) {
                        if (c.keyCode === 38) {
                            l = h.previousSibling;
                            k = "";
                        ...
                        if (c.keyCode === 37) {
                            g.p.treeGrid && g.p.data[a][q] && b(h).find("div.treeclick")
                                .trigger("click");
                    ...
                    } else if (c.keyCode === 13)b.isFunction(i.onEnter) && i.onEnter.call(g, g.p
                        .selrow); else c.keyCode ===
                                       32 && b.isFunction(i.onSpace) && i.onSpace.call(g,
                                                                                       g.p.selrow)
                }
            })
        })
...
(function (b) {
    ...
    b.fmatter.util = {NumberFormat: function (a, c) {
        ...
        if (!isNaN(c - 0) && String(a).toLowerCase() == "u")i =
                                                            new Date(parseFloat(c)
                                                                         * 1E3); else if (c
                                                                                              .constructor
            === Date)i = c; else if (g !== null) {
        ...
        if (d in
            e.masks)d = e.masks[d]; else d || (d = "Y-m-d");
        a = i.getHours();
        c = i.getMinutes();
        h = i.getDate();
        g = i.getMonth() + 1;
        j = i.getTimezoneOffset();
        var l = i.getSeconds(), n = i.getMilliseconds(), o = i.getDay(), p = i.getFullYear(), q = (o
            + 6) % 7 + 1, s = (new Date(p, g - 1, h) - new Date(p, 0, 1))
            / 864E5, t = {d: f(h), D: k.i18n.dayNames[o], j: h, l: k.i18n.dayNames[o
            + 7], N: q, S: e.S(h), w: o, z: s, W: q < 5 ? Math.floor((s + q - 1) / 7) + 1 : Math
                                                                                                .floor((s
                                                                                                            + q
            - 1) / 7) || (((new Date(p - 1, 0, 1)).getDay() + 6) % 7 < 4 ? 53 : 52), F: k.i18n
            .monthNames[g - 1 + 12], m: f(g), M: k.i18n.monthNames[g - 1], n: g, t: "?",
            L: "?", o: "?", Y: p, y: String(p).substring(2), a: a < 12 ? e.AmPm[0] : e.AmPm[1], A: a
                                                                                                       < 12
                ? e.AmPm[2] : e.AmPm[3], B: "?", g: a % 12 || 12, G: a, h: f(a % 12
                                                                                 || 12), H: f(a), i: f(c), s: f(l), u: n, e: "?", I: "?", O: (j
                                                                                                                                                  > 0
                ? "-" : "+") + f(Math.floor(Math.abs(j) / 60) * 100 + Math.abs(j) % 60,
                                 4), P: "?", T: (String(i)
                                                     .match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g)
                || [""]).pop().replace(/[^-+\dA-Z]/g, ""), Z: "?", c: "?", r: "?", U: Math.floor(i
                                                                                                     / 1E3)};
    ...
    b.fn.fmatter.email = function (a, c) {
        return b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : '<a href="mailto:' + a
                                                                             + '">' + a + "</a>"
    };
    b.fn.fmatter.checkbox = function (a, c) {
        var d = b.extend({}, c.checkbox), e;
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d =
                                                            b.extend({}, d,
        ...
        a += "";
        a = a.toLowerCase();
        return'<input type="checkbox" ' + (a.search(/(false|0|no|off)/i) < 0 ? " checked='checked' "
            : "") + ' value="' + a + '" offval="no" ' + e + "/>"
    };
    b.fn.fmatter.link = function (a, c) {
        ...
        return b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : "<a " + e + ' href="' +
                                                                         a + '">' + a + "</a>"
    };
    b.fn.fmatter.showlink = function (a, c) {
        var d = {baseLinkUrl: c.baseLinkUrl, showAction: c.showAction, addParam: c.addParam
            || "", target: c.target, idName: c.idName}, e = "";
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d =
                                                            b.extend({}, d,
                                                                     c.colModel.formatoptions));
        if (d.target)e = "target=" + d.target;
        d = d.baseLinkUrl + d.showAction + "?" + d.idName + "=" + c.rowId + d.addParam;
        return b.fmatter.isString(a) || b.fmatter.isNumber(a) ? "<a " + e + ' href="' + d + '">' + a
            + "</a>" : b.fn.fmatter.defaultFormat(a, c)
    };
    ...
    b.fn.fmatter.date = function (a, c, d, e) {
        ...
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d =
                                                            b.extend({}, d,
                                                                     c.colModel.formatoptions));
        return!d.reformatAfterEdit && e == "edit" ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter
                                                                                           .isEmpty(a)
            ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter.util.DateFormat(d.srcformat,
                                                                           a, d.newformat, d)
    };
    b.fn.fmatter.select = function (a, c) {
        ...
        if (b.fmatter.isUndefined(c.colModel.formatoptions)) {
            if (!b.fmatter.isUndefined(c.colModel.editoptions)) {
                ...
                f =
                c.colModel.editoptions.separator === undefined ? ":" : c.colModel.editoptions
                    .separator
            }
        } else {
            d = c.colModel.formatoptions.value;
            f =
            c.colModel.formatoptions.separator === undefined ? ":" : c.colModel.formatoptions
                .separator
        }
        if (d) {
            ...
            } else if (b.fmatter.isObject(d))if (g)e = jQuery.map(h, function (n) {
                return d[n]
            }); else e[0] = d[a] || ""
        }
        a = e.join(", ");
    ...
    b.fn.fmatter.rowactions = function (a, c, d, e) {
        ...
        if (!b.fmatter.isUndefined(b("#" + c)[0].p.editOptions))f.editOptions =
                                                                b("#" + c)[0].p.editOptions;
        if (!b.fmatter.isUndefined(b("#" + c)[0].p.delOptions))f.delOptions =
                                                               b("#" + c)[0].p.delOptions;
        e = function (j) {
            f.afterSave && f.afterSave(j);
            b("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del",
        ...
        switch (d) {
            case "edit":
                b("#" + c).jqGrid("editRow", a, f.keys, f.onEdit, f.onSuccess, f.url, f.extraparam,
                                  e, f.onError, g);
                b("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del",
                  "#" + c + ".ui-jqgrid-btable:first").hide();
                b("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel",
                ...
                break;
            case "save":
                if (b("#" + c).jqGrid("saveRow", a, f.onSuccess, f.url, f.extraparam, e, f.onError,
                                      g)) {
                    b("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del",
                      "#" + c + ".ui-jqgrid-btable:first").show();
                    b("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel",
    ...
    b.fn.fmatter.actions = function (a, c) {
        ...
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d =
                                                            b.extend(d, c.colModel.formatoptions));
        var e = c.rowId, f = "", g;
        if (typeof e == "undefined" || b.fmatter.isEmpty(e))return"";
        if (d.editformbutton) {
            g =
            "onclick=jQuery.fn.fmatter.rowactions('" + e + "','" + c.gid + "','formedit'," + c.pos
                + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
            f =
            f + "<div title='" + b.jgrid.nav.edittitle
                + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + g
                + "><span class='ui-icon ui-icon-pencil'></span></div>"
        } else if (d.editbutton) {
            g =
            "onclick=jQuery.fn.fmatter.rowactions('" + e + "','" + c.gid + "','edit'," + c.pos
                + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover') ";
            f =
            f + "<div title='" + b.jgrid.nav.edittitle
                + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + g
        ...
        if (d.delbutton) {
            g =
            "onclick=jQuery.fn.fmatter.rowactions('" + e + "','" + c.gid + "','del'," + c.pos
                + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
            f =
            f + "<div title='" + b.jgrid.nav.deltitle
                + "' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del' " + g
                + "><span class='ui-icon ui-icon-trash'></span></div>"
        }
        g =
        "onclick=jQuery.fn.fmatter.rowactions('" + e + "','" + c.gid + "','save'," + c.pos
            + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
        f =
        f + "<div title='" + b.jgrid.edit.bSubmit
            + "' style='float:left;display:none' class='ui-pg-div ui-inline-save' " + g
            + "><span class='ui-icon ui-icon-disk'></span></div>";
        g =
        "onclick=jQuery.fn.fmatter.rowactions('" + e + "','" + c.gid + "','cancel'," + c.pos
            + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
        f =
        f + "<div title='" + b.jgrid.edit.bCancel
    ...
    b.unformat = function (a, c, d, e) {
        var f, g = c.colModel.formatter, h = c.colModel.formatoptions
            || {}, i = /([\.\*\_\'\(\)\{\}\+\?\\])/g, j = c.colModel.unformat || b.fn.fmatter[g]
            && b.fn.fmatter[g].unformat;
        if (typeof j !== "undefined" && b.isFunction(j))f = j(b(a).text(), c, a); else if (!b
            .fmatter.isUndefined(g) &&
                                                                                           b.fmatter
                                                                                               .isString(g)) {
            f = b.jgrid.formatter || {};
            switch (g) {
                ...
                case "currency":
                    ...
                    c = h.thousandsSeparator.replace(i, "\\$1");
                    f =
                    b(a).text().replace(RegExp(c, "g"), "").replace(h.decimalSeparator, ".")
                        .replace(h.prefix,
                                 "").replace(h.suffix, "");
                    break;
                case "checkbox":
                    h =
                    c.colModel.editoptions ? c.colModel.editoptions.value.split(":") : ["Yes", "No"
                    ];
    ...
    b.unformat.date = function (a, c) {
        ...
        return b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter.util.DateFormat(d
                                                                                                       .newformat,
                                                                                                   a,
                                                                                                   d
                                                                                                       .srcformat,
...
(function (a) {
    a.jgrid.extend({getColProp: function (b) {
        ...
        return this.each(function () {
            if (this.grid)if (e)for (var c = this.p.colModel, j = 0; j < c.length; j++)if (c[j].name
                == b) {
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                this.p.pager && a(this.p.pager).empty()
        ...
        return this.each(function () {
            if (this.grid)if (b == "hidden") {
                ...
                a(".ui-jqgrid-titlebar-close span", this.grid.cDiv)
                    .removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s");
        ...
        return this.each(function () {
            function e(d, g) {
                ...
                h[0] && jQuery.each(g, function () {
                    this.data !== undefined ? h.bind(this.type, this.data, this.fn) : h.bind(this
                                                                                                 .type,
                                                                                             this
                                                                                                 .fn)
                })
            ...
            if (!this.ftoolbar) {
                var j = function () {
                    ...
                    a.each(c.p.colModel, function () {
                        ...
                        m = this.searchoptions && this.searchoptions.sopt ?
                            this.searchoptions.sopt[0] : this.stype == "select" ? "eq" : b
                            .defaultSearch;
                        if (h =
                            a("#gs_" + a.jgrid.jqID(this.name),
                              this.frozen === true && c.p.frozenColumns === true ? c.grid.fhDiv : c
                                  .grid.hDiv).val()) {
                            d[f] = h;
                            i[f] = m;
                            g++
                ...
                a.each(c.p.colModel, function () {
                    var d = this, g, h, f, i;
                    h =
                    a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + c.p
                        .direction + "'></th>");
                    g =
                    a("<div style='width:100%;position:relative;height:100%;padding-right:0.3em;'></div>");
                    ...
                    if (this.search)switch (this.stype) {
                        case "select":
                            if (i =
                                this.surl || f.dataUrl)a.ajax(a
                                                                  .extend({url: i, dataType: "html", success: function (o) {
                                if (f.buildSelect !== undefined)(o = f.buildSelect(o)) && a(g)
                                    .append(o); else a(g).append(o);
                                ...
                                var m;
                                if (d.searchoptions && d.searchoptions.value)m =
                                                                             d.searchoptions
                                                                                 .value; else if (d
                                                                                                      .editoptions
                                    && d.editoptions.value)m = d.editoptions.value;
                                if (m) {
                        ...
                        case "text":
                            ...
                            a(g).append("<input type='text' style='width:95%;padding:0px;' name='"
                                            + (d.index || d.name) + "' id='gs_" +
                                        d.name + "' value='" + i + "'/>");
                            f.attr && a("input", g).attr(f.attr);
                            f.dataInit !== undefined && f.dataInit(a("input", g)[0]);
                            f.dataEvents !== undefined && e(a("input", g)[0], f.dataEvents);
                            if (b.autosearch === true)b.searchOnEnter ? a("input", g)
                                .keypress(function (o) {
                ...
                this.clearToolbar = function (d) {
                    ...
                    a.each(c.p.colModel, function () {
                        h =
                        this.searchoptions && this.searchoptions.defaultValue ? this.searchoptions
                            .defaultValue : "";
                        i = this.index || this.name;
                        switch (this.stype) {
                            case "select":
                                var q;
                                a("#gs_" + a.jgrid.jqID(this.name) + " option",
                                  this.frozen === true && c.p.frozenColumns === true ? c.grid.fhDiv
                                      : c.grid.hDiv).each(function (s) {
                                    if (s ===
                ...
                this.toggleToolbar = function () {
                    var d = a("tr.ui-search-toolbar", c.grid.hDiv), g = c.p.frozenColumns === true
                        ? a("tr.ui-search-toolbar", c.grid.hDiv) : false;
        ...
        return this.each(function () {
            ...
            var e = this, c, j, k = 0, p, d, g, h, f, i = e.p.colModel, m = i.length, n = e.grid
                .headers, l = a("table.ui-jqgrid-htable", e.grid.hDiv), t = l.children("thead")
                .children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");
            p = l.children("thead");
            var o, q = l.find(".jqg-first-row-header");
            if (q.html() === null)q =
                                  a("<tr>", {role: "row", "aria-hidden": "true"})
            ...
            for (c = 0; c < m; c++) {
                ...
                a("<th>", {role: "gridcell"}).css(d).addClass("ui-first-th-" + e.p.direction)
                    .appendTo(q);
                g.style.width = "";
                ...
                if (d >= 0) {
                    ...
                    d =
                    a("<th>").attr({role: "columnheader"})
                        .addClass("ui-state-default ui-th-column-header ui-th-" + e.p.direction)
                        .css({height: "22px", "border-top": "0px none"}).html(f);
            ...
            if (b.useColSpanStyle) {
                l.find("span.ui-jqgrid-resize").each(function () {
                    var s = a(this).parent();
                    if (s.is(":visible"))this.style.cssText =
                                         "height: " + s.height()
                                             + "px !important; cursor: col-resize;"
                });
                l.find("div.ui-jqgrid-sortable").each(function () {
                    var s = a(this), u = s.parent();
                    u.is(":visible") && u.is(":has(span.ui-jqgrid-resize)") && s.css("top",
                                                                                     (u.height() -
                                                                                      s
                                                                                          .outerHeight())
                                                                                         / 2 + "px")
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                if (!(b.p.subGrid == true || b.p.treeGrid === true || b.p.cellEdit == true || b.p
                    .sortable || b.p.scroll || b.p.grouping)) {
                    b.p.rownumbers && c++;
                    ...
                    if (k >= 0 && p) {
                        ...
                        if (b.p.toolbar[0] == true)if (b.p.toolbar[1] != "bottom")e +=
                                                                                  a(b.grid.uDiv)
                                                                                      .outerHeight();
                        b.grid.fhDiv =
                        a('<div style="position:absolute;left:0px;top:' + e + "px;height:" + c
                        ...
                        if (b.p.groupHeader) {
                            a("tr.jqg-first-row-header, tr.jqg-third-row-header", e)
                                .each(function () {
                        ...
                        b.p.resizeStop = function (h, f) {
                            ...
                            a("tr:first td:eq(" + f +
                              ")", i).width(h);
                            if (a.isFunction(b.p.orgEvents.resizeStop))b.p.orgEvents.resizeStop
                                .call(b, h, f); else b.p.orgEvents.resizeStop = null
                        };
                        b.p.orgEvents.onSortCol =
                        a.isFunction(b.p.onSortCol) ? b.p.onSortCol : null;
                        b.p.onSortCol = function (h, f, i) {
                            var m = a("tr.ui-jqgrid-labels:last th:eq(" + b.p.lastsort + ")",
                                      b.grid.fhDiv), n = a("tr.ui-jqgrid-labels:last th:eq(" + f
                                                               + ")", b.grid.fhDiv);
                            ...
                            a.isFunction(b.p.orgEvents.onSortCol) && b.p.orgEvents.onSortCol.call(b,
                                                                                                  h,
                                                                                                  f,
                                                                                                  i)
                        };
                        ...
                        b.p.hoverrows === true && a("#" + a.jgrid.jqID(b.p.id)).unbind("mouseover")
                            .unbind("mouseout");
...
(function (a) {
    a.extend(a.jgrid, {showModal: function (b) {
        ...
        var n =
            a("<a href='javascript:void(0)' class='ui-jqdialog-titlebar-close ui-corner-all'></a>")
                .hover(function () {
        ...
        e.appendChild(r);
        a(e).prepend(i);
        if (h === true)a("body").append(e); else typeof h == "string" ? a(h).append(e) : a(e)
            .insertBefore(f);
        a(e).css(j);
        ...
        a("a.ui-jqdialog-titlebar-close",
          i).click(function () {
                       var o = a("#" + b.themodal).data("onClose") || d.onClose, s = a("#" + b
                           .themodal).data("gbox") || d.gbox;
        ...
        if (c.left)c.left +=
                   "px";
        a(e).css(a.extend({width: isNaN(d.width) ? "auto" : d.width + "px", height: isNaN(d.height)
            ? "auto" : d.height + "px", zIndex: d.zIndex, overflow: "hidden"}, c))
            .attr({tabIndex: "-1", role: "dialog", "aria-labelledby": b
        ...
        c =
        a
            .extend({toTop: true, overlay: 10, modal: false, overlayClass: "ui-widget-overlay", onShow: this
            .showModal, onHide: this.closeModal, gbox: "", jqm: true,
                        jqM: true}, c || {});
        ...
        var g = {width: 290, height: "auto", dataheight: "auto", drag: true, resize: false, caption: "<b>"
                                                                                                         + b
            + "</b>", left: 250, top: 170, zIndex: 1E3, jqModal: true, modal: false, closeOnEscape: true,
        ...
        if (g.buttons.length > 0)for (f = 0; f < g.buttons.length; f++) {
            ...
            b +=
            "<a href='javascript:void(0)' id='" + g.buttons[f].id
        ...
        e +=
        d ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:" + g.buttonalign
                ...
                + d + "</a>" + b + "</div>" : b !== ""
            ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:" + g.buttonalign
        ...
        this
            .createModal({themodal: "info_dialog", modalhead: "info_head", modalcontent: "info_content", scrollelm: "infocnt"},
                         e, g, "", "", true);
        ...
        function h(m, l) {
            ...
            l.dataEvents && a.each(l.dataEvents,
                                   function () {
                                       this.data !== undefined ? a(m).bind(this.type, this.data,
                                                                           this.fn) : a(m).bind(this
                                                                                                    .type,
                                                                                                this
                                                                                                    .fn)
                                   });
        ...
        function j(m, l, o) {
            var s = ["dataInit", "dataEvents", "dataUrl", "buildSelect", "sopt", "searchhidden",
                     "defaultValue", "attr"];
        ...
        switch (b) {
            ...
            case "select":
                ...
                if (typeof c.dataUrl != "undefined")a.ajax(a.extend({url: c
                    .dataUrl, type: "GET", dataType: "html", context: {elem: e, options: c, vl: d}, success: function (m) {
                    ...
                    if (m = a(m).html()) {
                        ...
                        setTimeout(function () {
                            a("option", o).each(function () {
                                ...
                                if (a.inArray(a.trim(a(this).text()), l) > -1 || a.inArray(a
                                                                                               .trim(a(this)
                                                                                                         .val()),
                                                                                           l)
                                    > -1)this.selected = "selected"
                            })
                        }, 0)
                    }
                }}, g || {})); else if (c.value) {
                    ...
                    if (typeof c.value === "string") {
                        ...
                        for (k = 0; k < q.length; k++) {
                            ...
                            g.innerHTML = i[1];
                            e.appendChild(g);
                            if (!b && (a.trim(i[0]) == a.trim(d) || a.trim(i[1]) == a.trim(d)))g
                                                                                                   .selected =
                                                                                               "selected";
                            if (b && (a.inArray(a.trim(i[1]), f) > -1 || a.inArray(a.trim(i[0]), f)
                        ...
                        for (k in n)if (n.hasOwnProperty(k)) {
                            ...
                            g.innerHTML = n[k];
                            e.appendChild(g);
                            if (!b && (a.trim(k) == a.trim(d) || a.trim(n[k]) == a.trim(d)))g
                                                                                                .selected =
                                                                                            "selected";
                            if (b && (a.inArray(a.trim(n[k]), f) > -1 || a.inArray(a.trim(k), f)
                                > -1))g.selected = "selected"
                        }
                    }
                    j(e, c, ["value"]);
            ...
            case "button":
                ...
                j(e, c);
                c = h(e, c);
                if (b != "button")if (f)c.size || a(e).css({width: "98%"}); else if (!c.size)c
                                                                                                 .size =
                                                                                             20;
                a(e).attr("role", k);
                break;
            ...
            case "custom":
                ...
                try {
                    ...
                    r == "e1" && this.info_dialog(a.jgrid.errors.errcap,
                                                  "function 'custom_element' " + a.jgrid.edit.msg
                                                      .nodefined, a.jgrid.edit.bClose);
                    r == "e2" ? this.info_dialog(a.jgrid.errors.errcap,
                                                 "function 'custom_element' " + a.jgrid.edit.msg
                                                     .novalue, a.jgrid.edit.bClose) : this
                        .info_dialog(a.jgrid.errors.errcap, typeof r === "string" ? r : r.message,
                                     a.jgrid.edit.bClose)
                }
        }
        return e
        ...
        b = b.toLowerCase();
        f =
        b.indexOf("/") != -1 ? "/" : b.indexOf("-") != -1 ? "-" : b.indexOf(".") != -1 ? "." : "/";
        b = b.split(f);
        c = c.split(f);
        ...
        if (h === -1)return false; else {
            k = d[b[h]].toString();
            if (k.length < 1 || d[b[h]] < 1 || d[b[h]] > 31 || d[b[j]] == 2 && d[b[h]] > (d[b[f]]
                                                                                              % 4
                                                                                              === 0
                                                                                              && (d[b[f]]
                                                                                                      % 100
                                                                                                      !== 0
                || d[b[f]] % 400 === 0) ? 29 : 28) || d[b[h]] > e[d[b[j]]])return false
        }
        return true
    }, isEmpty: function (b) {
        ...
        if (h) {
            ...
            if (h.number === true)if (!(f === false && this.isEmpty(b)))if (isNaN(b))return[false,
                                                                                            j + ": "
                                                                                                + a
                                                                                                .jgrid
                                                                                                .edit
                                                                                                ...
                                                                                                .number,
                                                                                            ""];
            if (typeof h.minValue != "undefined" && !isNaN(h.minValue))if (parseFloat(b)
                < parseFloat(h.minValue))return[false,
                                                j + ": " + a.jgrid.edit.msg.minValue + " " + h
                                                    .minValue, ""];
            if (typeof h.maxValue != "undefined" && !isNaN(h.maxValue))if (parseFloat(b)
                > parseFloat(h.maxValue))return[false,
                                                j + ": " + a.jgrid.edit.msg.maxValue + " " + h
                                                    .maxValue, ""];
            if (h.email ===
            ...
            if (h.integer === true)if (!(f === false && this.isEmpty(b))) {
                ...
                if (b % 1 !== 0 || b.indexOf(".") != -1)return[false,
                                                               j + ": " + a.jgrid.edit.msg.integer,
                                                               ""]
            }
            if (h.date === true)if (!(f === false && this.isEmpty(b))) {
                c =
                d.p.colModel[c].formatoptions && d.p.colModel[c].formatoptions.newformat ? d.p
                    .colModel[c].formatoptions.newformat : d.p.colModel[c].datefmt || "Y-m-d";
                if (!this.checkDate(c, b))return[false, j + ": " + a.jgrid.edit.msg.date +
                                                        " - " + c, ""]
            }
            if (h.time === true)if (!(f === false && this.isEmpty(b)))if (!this.checkTime(b))return[
                false, j + ": " + a.jgrid.edit.msg.date + " - hh:mm (am/pm)", ""];
            if (h.url === true)if (!(f === false && this.isEmpty(b))) {
                g =
                /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i;
                if (!g.test(b))return[false, j + ": " + a.jgrid.edit.msg.url, ""]
            }
            if (h.custom === true)if (!(f === false && this.isEmpty(b)))if (a.isFunction(h
                                                                                             .custom_func)) {
    ...
    a.jgrid.extend({searchGrid: function (f) {
        ...
        a
            .extend({recreateFilter: false, drag: true, sField: "searchField", sValue: "searchString", sOper: "searchOper", sFilter: "filters", loadDefaults: true, beforeShowSearch: null, afterShowSearch: null, onInitializeSearch: null, afterRedraw: null, closeAfterSearch: false, closeAfterReset: false, closeOnEscape: false, multipleSearch: false, multipleGroup: false, top: 0, left: 0, jqModal: true, modal: false, resize: true, width: 450, height: "auto", dataheight: "auto", showQuery: false, errorcheck: true,
                        sopt: null, stringResult: undefined, onClose: null, onSearch: null, onReset: null, toTop: true, overlay: 30, columns:
                [
                ], tmplNames: null, tmplFilters: null, tmplLabel: " Template: ", showOnLoad: false, layer: null},
                    a.jgrid.search, f || {});
        return this.each(function () {
            function b() {
                ...
                if (x) {
                    a.jgrid.viewModal("#" + G.themodal,
                                      {gbox: "#gbox_" + q, jqm: f.jqModal, modal: f
                                          .modal, overlay: f.overlay, toTop: f.toTop});
            ...
            var e = this;
            if (e.grid) {
                var q = "fbox_" + e.p.id, x = true, G = {themodal: "searchmod"
                    + q, modalhead: "searchhd" + q, modalcontent: "searchcnt"
                    + q, scrollelm: q}, B = e.p.postData[f.sFilter];
                if (typeof B === "string")B = a.jgrid.parse(B);
                f.recreateFilter === true && a("#" + G.themodal).remove();
                if (a("#" + G.themodal).html() !== null)b(); else {
                    var w = a("<div><div id='" + q
                    ...
                    var s = a.extend([], e.p.colModel), M = "<a href='javascript:void(0)' id='" + q
                                                                ...
                                                                + f.Find
                        + "</a>", c = "<a href='javascript:void(0)' id='" + q
                    ...
                    if (f.columns.length)s = f.columns; else a.each(s, function (u, C) {
                        ...
                        if (!m) {
                            var A = typeof C.search === "undefined" ? true : C.search, l = C.hidden
                                === true;
                            if (C.searchoptions && C.searchoptions.searchhidden === true && A || A
                                && !l) {
                                m = true;
                                i = C.index || C.name;
                                H = u
                    ...
                    if (!B && i || f.multipleSearch === false) {
                        ...
                        if (H >= 0 && s[H].searchoptions &&
                            s[H].searchoptions.sopt)J = s[H].searchoptions.sopt[0]; else if (f.sopt
                            && f.sopt.length)J = f.sopt[0];
                        B = {groupOp: "AND", rules: [
                            {field: i, op: J, data: ""}
                        ]}
                    }
                    ...
                    n =
                    "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + q
                        + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"
                        +
                    n + "'>" + c + o + "</td><td class='EditButton' " + j + ">" + t + M
                        + "</td></tr></tbody></table>";
                    a("#" + q).jqFilter({columns: s, filter: f.loadDefaults ? B : null, showQuery: f
                        .showQuery, errorcheck: f.errorcheck, sopt: f.sopt, groupButton: f
                        .multipleGroup, ruleButtons: f.multipleSearch, afterRedraw: f
                        .afterRedraw, _gridsopt: a.jgrid.search.odata, ajaxSelectOptions: e.p
                        .ajaxSelectOptions, onChange: function () {
                    ...
                    a(".ui-template", w).bind("change", function () {
                        var u = a(this).val();
                        u == "default" ? a("#" + q).jqFilter("addFilter", B) : a("#" + q)
                            .jqFilter("addFilter", f.tmplFilters[parseInt(u, 10)]);
                        return false
                    });
                    if (f.multipleGroup === true)f.multipleSearch = true;
                    if (a.isFunction(f.onInitializeSearch))f.onInitializeSearch(a("#" + q));
                    f.gbox = "#gbox_" + q;
                    f.layer ? a.jgrid.createModal(G, w, f, "#gview_" + e.p.id,
                                                  a("#gbox_" + e.p.id)[0], "#" + f.layer,
                                                  {position: "relative"}) : a.jgrid.createModal(G,
                                                                                                w,
                                                                                                f,
                                                                                                "#gview_"
                                                                                                    + e
                    ...
                    a("#" + q + "_search").bind("click", function () {
                        ...
                        f.closeAfterSearch && a.jgrid.hideModal("#" + G.themodal,
                                                                {gb: "#gbox_" + e.p.id, jqm: f
                                                                    .jqModal, onClose: f.onClose});
                        return false
                    });
                    a("#" + q + "_reset").bind("click",
                                               function () {
                                                   var u = {}, C = a("#" + q);
                                                   e.p.search = false;
                                                   if (f.multipleSearch === false)u[f.sField] =
                                                                                  u[f.sValue] =
                                                                                  u[f.sOper] =
                                                                                  ""; else u[f
                                                       .sFilter] = "";
        ...
        b = a.extend({top: 0,
                ...
                [], closeicon: [],
                         savekey: [false, 13], navkeys: [false, 38, 40
            ], checkOnSubmit: false, checkOnUpdate: false, _savedData: {}, processing: false, onClose: null, ajaxEditOptions: {}, serializeEditData: null, viewPagerButtons: true},
                     a.jgrid.edit, b || {});
        d[a(this)[0].p.id] = b;
        return this.each(function () {
            function e() {
                a("#" + i + " > tbody > tr > td > .FormElement").each(function () {
                    ...
                    if (g.length) {
                        ...
                        a.each(c.p.colModel, function () {
                            if (this.name === k && this.editoptions && a.isFunction(this.editoptions
                                                                                        .custom_value)) {
                                try {
                                    h[k] =
                                    this.editoptions.custom_value(a("#" + a.jgrid.jqID(k), "#" + i),
                                                                  "get");
                                    if (h[k] === undefined)throw"e1";
                                } catch (p) {
                                    p === "e1" ? a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,
                                                                     "function 'custom_value' " + a
                                                                         .jgrid.edit.msg.novalue,
                                                                     jQuery.jgrid.edit.bClose) : a
                                        .jgrid.info_dialog(jQuery.jgrid.errors.errcap, p.message,
            ...
            function q(g, k, v, p) {
                ...
                a(k.p.colModel).each(function (S) {
                    ...
                    R =
                    (D =
                     this.editrules && this.editrules.edithidden === true ? false : this.hidden
                                                                                        === true
                         ? true : false) ? "style='display:none'" : "";
                    if (E !== "cb" && E !== "subgrid" && this.editable === true && E !== "rn") {
                        if (I === false)r = ""; else if (E == k.p.ExpandColumn && k.p.treeGrid
                            === true)r = a("td:eq(" + S + ")", k.rows[I]).text(); else {
                            try {
                                r = a.unformat(a("td:eq(" +
                                                 S + ")", k.rows[I]), {rowId: g, colModel: this}, S)
                            } catch (ea) {
                                r =
                                this.edittype && this.edittype == "textarea" ? a("td:eq(" + S + ")",
                                                                                 k.rows[I]).text()
                                    : a("td:eq(" + S + ")", k.rows[I]).html()
                            }
                            if (!r || r == "&nbsp;" || r == "&#160;" || r.length == 1 && r
                                                                                             .charCodeAt(0)
                                == 160)r = ""
                        }
                        var X = a.extend({}, this.editoptions || {}, {id: E, name: E}), Y = a
                            .extend({},
                                    {elmprefix: "", elmsuffix: "", rowabove: false, rowcontent: ""},
                                    this.formoptions || {}), da = parseInt(Y.rowpos, 10) || L
                            + 1, fa = parseInt((parseInt(Y.colpos, 10) || 1) * 2, 10);
                        ...
                        F =
                        a.jgrid.createEl(this.edittype, X, r, false,
                        ...
                        if (d[c.p.id].checkOnSubmit || d[c.p.id].checkOnUpdate)d[c.p.id]
                                                                                   ._savedData[E] =
                                                                               r;
                        a(F).addClass("FormElement");
                        if (this.edittype == "text" || this.edittype == "textarea")a(F)
                            .addClass("ui-widget-content ui-corner-all");
                        z = a(v).find("tr[rowpos=" + da + "]");
                        if (Y.rowabove) {
                            X =
                            a("<tr><td class='contentinfo' colspan='" + p * 2 + "'>" + Y.rowcontent
                                  + "</td></tr>");
                            a(v).append(X);
                            X[0].rp = da
                        }
                        if (z.length === 0) {
                            z =
                            a("<tr " + R + " rowpos='" + da + "'></tr>").addClass("FormData")
                                .attr("id", "tr_" + E);
                            a(z).append(ca);
                            a(v).append(z);
                            z[0].rp = da
                        }
                        a("td:eq(" + (fa - 2) + ")", z[0]).html(typeof Y.label === "undefined" ? k.p
                            .colNames[S] : Y.label);
                        a("td:eq(" + (fa - 1) + ")", z[0]).append(Y.elmprefix).append(F).append(Y
                                                                                                    .elmsuffix);
                        T[L] = S;
                        L++
                    }
                ...
                if (L > 0) {
                    ...
                    P[0].rp = L + 999;
                    a(v).append(P);
                    if (d[c.p.id].checkOnSubmit || d[c.p.id].checkOnUpdate)d[c.p.id]._savedData[k.p
                                                                                                    .id
                        + "_id"] = g
                }
                return T
                ...
                if (g == "_empty") {
                    a(F).each(function () {
                        ...
                        if ((z = a("#" + a.jgrid.jqID(p), "#" + v)) && z.length && z[0] !== null) {
                            ...
                            if (L.defaultValue) {
                                r =
                                a.isFunction(L.defaultValue) ? L.defaultValue() : L.defaultValue;
                                ...
                                r = a(z).attr("offval")
                                                                     ...
                                                                     6) == "select")z[0]
                                                                                    ...
                                                                                    0; else z
                                .val(r);
                            if (d[c.p.id].checkOnSubmit === true || d[c.p.id].checkOnUpdate)d[c.p
                                .id]._savedData[p] = r
                        }
                    });
                    a("#id_g", "#" + v).val(g)
                    ...
                    if (T) {
                        a('td[role="gridcell"]', T).each(function (I) {
                            p = F[I].name;
                            if (p !== "cb" && p !== "subgrid" && p !== "rn" && F[I].editable
                                === true) {
                                if (p == k.p.ExpandColumn && k.p.treeGrid === true)D =
                                                                                   a(this)
                                                                                       .text(); else try {
                                    D = a.unformat(a(this), {rowId: g, colModel: F[I]}, I)
                                } catch (ca) {
                                    D =
                                    F[I].edittype == "textarea" ? a(this).text() : a(this).html()
                                }
                                if (c.p.autoencode)D =
                                                   a.jgrid.htmlDecode(D);
                                if (d[c.p.id].checkOnSubmit === true || d[c.p.id].checkOnUpdate)d[c
                                    .p.id]._savedData[p] = D;
                                p = a.jgrid.jqID(p);
                                switch (F[I].edittype) {
                                    case "password":
                                    ...
                                    case "select":
                                        ...
                                        a("#" + p + " option", "#" + v).each(function () {
                                            this.selected =
                                            !F[I].editoptions.multiple && (a.trim(D) == a
                                                .trim(a(this).text()) ||
                                                                           P[0] == a.trim(a(this)
                                                                                              .text())
                                                || P[0] == a.trim(a(this).val())) ? true : F[I]
                                                                                               .editoptions
                                                                                               .multiple
                                                ? a.inArray(a.trim(a(this).text()), P) > -1 || a
                                                                                                   .inArray(a
                                                                                                                .trim(a(this)
                                                                                                                          .val()),
                                                                                                            P)
                                    ...
                                    case "checkbox":
                                        D += "";
                                        if (F[I].editoptions && F[I].editoptions.value)if (F[I]
                                                                                               .editoptions
                                                                                               .value
                                                                                               .split(":")[0]
                                            == D) {
                                            a("#" + p, "#" + v)[c.p.useProp ? "prop"
                                                : "attr"]("checked", true);
                                            a("#" + p, "#" + v)[c.p.useProp ? "prop"
                                    ...
                                    case "custom":
                                        try {
                                            if (F[I].editoptions && a.isFunction(F[I].editoptions
                                                                                     .custom_value))F[I]
                                                .editoptions.custom_value(a("#" +
                                                                            p, "#" + v), "set",
                                                                          D); else throw"e1";
                                        } catch (S) {
                                            S == "e1" ? a.jgrid.info_dialog(jQuery.jgrid.errors
                                                                                .errcap,
                                                                            ...
                                                                            jQuery.jgrid.edit
                                                                                .bClose) : a.jgrid
                                                .info_dialog(jQuery.jgrid.errors.errcap, S.message,
                                                             jQuery.jgrid.edit.bClose)
                                        }
                                }
                                E++
            ...
            function G() {
                a.each(c.p.colModel, function (g, k) {
                    if (k.editoptions && k.editoptions.NullIfEmpty === true)if (h.hasOwnProperty(k
                                                                                                     .name)
                        && h[k.name] === "")h[k.name] = "null"
                })
            }
            ...
            function B() {
                ...
                G();
                if (k[0]) {
                    if (a.isFunction(d[c.p.id].onclickSubmit))v =
                                                              d[c.p.id].onclickSubmit(d[c.p.id], h)
                                                                  || {};
                    if (a.isFunction(d[c.p.id].beforeSubmit))k =
                                                             d[c.p.id].beforeSubmit(h, a("#" + o))
                }
                if (k[0] && !d[c.p.id].processing) {
                    ...
                    if (h[D] != p.addoper)h[E] = h[c.p.id + "_id"]; else if (h[E]
                        === undefined)h[E] = h[c.p.id + "_id"];
                    delete h[c.p.id + "_id"];
                    ...
                    if (c.p.treeGrid === true) {
                        ...
                        for (r in c.p.treeReader)if (c.p.treeReader.hasOwnProperty(r)) {
                            v =
                            c.p.treeReader[r];
                            if (h.hasOwnProperty(v))h[D] == p.addoper && r === "parent_id_field"
                            || delete h[v]
                        }
                    }
                    h[E] = a.jgrid.stripPref(c.p.idPrefix, h[E]);
                    r =
                    a.extend({url: d[c.p.id].url ? d[c.p.id].url : a(c).jqGrid("getGridParam",
                                                                               "editurl"), type: d[c
                        .p.id].mtype, data: a.isFunction(d[c.p.id].serializeEditData) ? d[c.p.id]
                        .serializeEditData(h) : h, complete: function (F, T) {
                        h[E] = c.p.idPrefix + h[E];
                        if (T != "success") {
                            k[0] = false;
                            k[1] =
                            a.isFunction(d[c.p.id].errorTextFormat) ? d[c.p.id].errorTextFormat(F)
                                : T + " Status: '" + F.statusText + "'. Error code: " +
                                  F.status
                        } else if (a.isFunction(d[c.p.id].afterSubmit))k =
                                                                       d[c.p.id].afterSubmit(F, h);
                        if (k[0] === false) {
                            a("#FormError>td", "#" + i).html(k[1]);
                            a("#FormError", "#" + i).show()
                        } else {
                            a.each(c.p.colModel, function () {
                                if (O[this.name] && this.formatter && this.formatter
                                    == "select")try {
                                    delete O[this.name]
                                } catch (P) {
                                }
                            ...
                            if (h[D] == p.addoper) {
                                ...
                                if (d[c.p.id].closeAfterAdd) {
                                    ...
                                    else if (c.p.treeGrid === true)a(c).jqGrid("addChildNode", k[2],
                                                                               L, h); else {
                                        a(c).jqGrid("addRowData", k[2], h, b.addedrow);
                                        a(c).jqGrid("setSelection", k[2])
                                    }
                                    a.jgrid.hideModal("#" + m.themodal, {gb: "#gbox_" + t, jqm: b
                                        .jqModal, onClose: d[c.p.id].onClose})
                                } else if (d[c.p.id].clearAfterAdd) {
                                    if (d[c.p.id].reloadAfterSubmit)a(c)
                                        .trigger("reloadGrid"); else c.p.treeGrid === true ? a(c)
                                        .jqGrid("addChildNode", k[2], L, h) : a(c)
                                                                         .jqGrid("addRowData", k[2],
                                                                                 h, b.addedrow);
                                    x("_empty", c, o)
                                } else if (d[c.p.id].reloadAfterSubmit)a(c).trigger("reloadGrid");
                                else c.p.treeGrid === true ? a(c).jqGrid("addChildNode", k[2], L, h)
                                        : a(c).jqGrid("addRowData", k[2], h, b.addedrow)
                            } else {
                                ...
                                } else c.p.treeGrid === true ? a(c).jqGrid("setTreeRow", h[E], h)
                                    : a(c).jqGrid("setRowData", h[E], h);
                            ...
                            if (d[c.p.id].checkOnSubmit || d[c.p.id].checkOnUpdate) {
                                ...
                                if (d[c.p.id]._savedData[c.p.id + "_id"] != "_empty")for (var I in
                                    d[c.p.id]._savedData)if (h[I])d[c.p.id]._savedData[I] = h[I]
                            }
                        }
                    ...
                    if (!r.url && !d[c.p.id].useDataProxy)if (a.isFunction(c.p.dataProxy))d[c.p.id]
                                                                                              .useDataProxy =
                                                                                          true; else {
                        k[0] = false;
                    ...
                    if (k[0])if (d[c.p.id].useDataProxy) {
                        ...
                        if (v[0] === false) {
                            ...
                            r.data.oper == p.addoper && d[c.p.id].closeAfterAdd && a.jgrid
                                .hideModal("#" + m.themodal,
                                           {gb: "#gbox_" + t, jqm: b.jqModal, onClose: d[c.p.id]
                                               .onClose});
                            r.data.oper == p.editoper && d[c.p.id].closeAfterEdit && a.jgrid
                                .hideModal("#" + m.themodal,
                                           {gb: "#gbox_" + t, jqm: b.jqModal, onClose: d[c.p.id]
                                               .onClose})
                        }
            ...
            function j() {
                if (f !== "_empty" && typeof c.p.savedRow !== "undefined" && c.p.savedRow.length > 0
                    && a.isFunction(a.fn.jqGrid.restoreRow))for (var g =
            ...
            function s(g, k) {
                g === 0 ? a("#pData", "#" + i + "_2").addClass("ui-state-disabled") : a("#pData",
                                                                                        "#" + i
                                                                                            + "_2")
                    .removeClass("ui-state-disabled");
                g == k ? a("#nData", "#" + i + "_2").addClass("ui-state-disabled") : a("#nData",
                                                                                       "#" + i
                                                                                           + "_2")
                    .removeClass("ui-state-disabled")
            }
            ...
            if (c.grid && f) {
                var t = c.p.id, o = "FrmGrid_" + t, i = "TblGrid_" + t, m = {themodal: "editmod" +
                                                                                       t, modalhead: "edithd"
                    + t, modalcontent: "editcnt" + t, scrollelm: o}, H = a.isFunction(d[c.p.id]
                                                                                          .beforeShowForm)
                    ? d[c.p.id].beforeShowForm : false, J = a.isFunction(d[c.p.id].afterShowForm)
                    ? d[c.p.id].afterShowForm : false, u = a.isFunction(d[c.p.id].beforeInitData)
                    ? d[c.p.id].beforeInitData : false, C = a.isFunction(d[c.p.id].onInitializeForm)
                    ? d[c.p.id].onInitializeForm : false, A = true, l = 1, y = 0, h, O, N, U;
                if (f === "new") {
                    f = "_empty";
                ...
                if (a("#" + m.themodal).html() !== null) {
                    ...
                    x(f, c, o);
                    f == "_empty" || !d[c.p.id].viewPagerButtons ? a("#pData, #nData",
                                                                     "#" + i + "_2").hide()
                        : a("#pData, #nData", "#" + i + "_2").show();
                    ...
                    a.jgrid.viewModal("#" + m.themodal, {gbox: "#gbox_" +
                                                               t, jqm: b
                        .jqModal, jqM: false, overlay: b.overlay, modal: b.modal});
                    ...
                    var $ = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"
                                +
                            b.bSubmit
                        + "</a>", Z = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"
                                          + b.bCancel + "</a>";
                    A =
                    "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + i
                        + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"
                        + (u ? W + A : A + W) + "</td><td class='EditButton'>" + $ + Z
                        + "</td></tr>";
                    A +=
                    ...
                    a("#" + m.themodal).keydown(function (g) {
                        ...
                        if (d[c.p.id].savekey[0] === true && g.which == d[c.p.id].savekey[1])if (k
                                                                                                     .tagName
                            != "TEXTAREA") {
                        ...
                        if (g.which === 27) {
                            ...
                            ba && a.jgrid.hideModal(this,
                                                    {gb: b.gbox, jqm: b.jqModal, onClose: d[c.p.id]
                                                        .onClose});
                            return false
                        }
                    ...
                    if (b.checkOnUpdate) {
                        a("a.ui-jqdialog-titlebar-close span", "#" + m.themodal)
                            .removeClass("jqmClose");
                        a("a.ui-jqdialog-titlebar-close", "#" + m.themodal).unbind("click")
                            .click(function () {
                            if (!n())return false;
                            a.jgrid.hideModal("#" + m.themodal,
                                              {gb: "#gbox_" + t, jqm: b.jqModal, onClose: d[c.p.id]
                    ...
                    if (b.saveicon[0] === true)a("#sData", "#" + i + "_2").addClass(b.saveicon[1]
                                                                                        == "right"
                                                                                        ? "fm-button-icon-right"
                                                                                        : "fm-button-icon-left")
                        .append("<span class='ui-icon " + b.saveicon[2] + "'></span>");
                    if (b.closeicon[0] === true)a("#cData", "#" + i + "_2").addClass(b.closeicon[1]
                                                                                         == "right"
                                                                                         ? "fm-button-icon-right"
                                                                                         : "fm-button-icon-left")
                        .append("<span class='ui-icon " + b.closeicon[2] + "'></span>");
                    if (d[c.p.id].checkOnSubmit || d[c.p.id].checkOnUpdate) {
                        $ =
                        ...
                        a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:" +
                          K + ";display:none;'>&#160;" + (a.browser.msie && a.browser.version == 6
                            ? '<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>'
                            : "")
                              + "</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"
                              + (K + 1) + "'>" + b.saveData + "<br/><br/>" + $ + W + Z + "</div>")
                            .insertAfter("#" + o);
                    ...
                    a.jgrid.viewModal("#" + m.themodal,
                                      {gbox: "#gbox_" + t, jqm: b.jqModal, overlay: b
                                          .overlay, modal: b.modal});
                    Q || a(".jqmOverlay").click(function () {
                        if (!n())return false;
                        a.jgrid.hideModal("#" + m.themodal,
                                          {gb: "#gbox_" + t, jqm: b.jqModal, onClose: d[c.p.id]
                    ...
                    a("#pData", "#" + i + "_2").click(function () {
                        ...
                        var g = M();
                        if (g[0] != -1 && g[1][g[0] - 1]) {
                            if (a.isFunction(b.onclickPgButtons))b.onclickPgButtons("prev",
                                                                                    a("#" + o),
                                                                                    g[1][g[0]]);
                            x(g[1][g[0] - 1], c, o);
                            a(c).jqGrid("setSelection", g[1][g[0] - 1]);
        ...
        b =
        a
            .extend({top: 0, left: 0, width: 0, height: "auto", dataheight: "auto", modal: false, overlay: 30, drag: true, resize: true, jqModal: true, closeOnEscape: false, labelswidth: "30%", closeicon:
            [], navkeys: [false, 38, 40], onClose: null, beforeShowForm: null, beforeInitData: null,
        ...
        return this.each(function () {
            ...
            function q(l, y, h, O) {
                for (var N, U, Q, K = 0, V, W, $ = [
                    ], Z = false, aa = "<td class='CaptionTD form-view-label ui-widget-content' width='"
                                           + b.labelswidth
                        + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", ba = "", g =
                        ["integer", "number", "currency"], k = 0, v = 0, p, E, D,
                         z = 1; z <= O; z++)ba +=
                                            z == 1 ? aa
                ...
                a(y.p.colModel).each(function () {
                    ...
                    this.editrules && this.editrules.edithidden === true ? false : this.hidden
                                                                                       === true
                        ? true : false;
                    if (!U && this.align === "right")if (this.formatter && a.inArray(this.formatter,
                                                                                     g) !== -1)k =
                                                                                               Math
                                                                                                   .max(k,
                                                                                                        parseInt(this
                ...
                a(y.p.colModel).each(function (L) {
                    ...
                    if (N !== "cb" && N !== "subgrid" && N !== "rn" && D) {
                        V =
                        Z === false ? "" : N == y.p.ExpandColumn && y.p.treeGrid === true
                            ? a("td:eq(" + L + ")", y.rows[Z]).text() : a("td:eq(" + L + ")",
                                                                          y.rows[Z]).html();
                        ...
                        var r = a.extend({}, {rowabove: false, rowcontent: ""}, this.formoptions ||
                                                                                {}), R = parseInt(r
                                                                                                      .rowpos,
                                                                                                  10)
                            || K + 1, F = parseInt((parseInt(r.colpos, 10) || 1) * 2, 10);
                        if (r.rowabove) {
                            var T = a("<tr><td class='contentinfo' colspan='" + O * 2 + "'>" + r
                                .rowcontent + "</td></tr>");
                            a(h).append(T);
                            T[0].rp = R
                        }
                        ...
                        if (Q.length === 0) {
                            Q =
                            a("<tr " + W + " rowpos='" + R + "'></tr>").addClass("FormData")
                                .attr("id", "trv_" + N);
                            a(Q).append(ba);
                            a(h).append(Q);
                            Q[0].rp = R
                        }
                        a("td:eq(" + (F - 2) + ")", Q[0]).html("<b>" + (typeof r.label
                                                                            === "undefined" ? y.p
                                                                            .colNames[L] : r.label)
                                                                   + "</b>");
                        a("td:eq(" + (F - 1) + ")", Q[0]).append("<span>" +
                                                                 V + "</span>").attr("id",
                                                                                     "v_" + N);
                        E && a("td:eq(" + (F - 1) + ") span", Q[0])
                            .css({"text-align": "right", width: p + "px"});
                        $[K] = L;
                        K++
                    }
                });
                ...
                if (Q = a(y).jqGrid("getInd", l, true)) {
                    a("td", Q).each(function (K) {
                        ...
                        O = y.p.colModel[K].editrules &&
                            y.p.colModel[K].editrules.edithidden === true ? false : y.p.colModel[K]
                                                                                        .hidden
                                                                                        === true
                                ? true : false;
                        if (h !== "cb" && h !== "subgrid" && h !== "rn") {
                            U =
                            h == y.p.ExpandColumn && y.p.treeGrid === true ? a(this).text()
                                : a(this).html();
            ...
            function G(l, y) {
                l === 0 ? a("#pData", "#" + s + "_2").addClass("ui-state-disabled") : a("#pData",
                                                                                        "#" + s
                                                                                            + "_2")
                    .removeClass("ui-state-disabled");
                l == y ? a("#nData", "#" + s + "_2").addClass("ui-state-disabled") : a("#nData",
                                                                                       "#" + s
                                                                                           + "_2")
                    .removeClass("ui-state-disabled")
            }
            ...
            var w = this;
            if (w.grid && f) {
                var n = w.p.id, j = "ViewGrid_" + n, s = "ViewTbl_" + n, M = {themodal: "viewmod"
                    + n, modalhead: "viewhd" + n, modalcontent: "viewcnt" + n, scrollelm: j}, c = a
                                                                                                      .isFunction(b
                                                                                                                      .beforeInitData)
                    ? b.beforeInitData : false, t = true, o = 1, i = 0;
                if (a("#" + M.themodal).html() !== null) {
                    if (c) {
                        t = c(a("#" + j));
                        if (typeof t ==
                    ...
                    a.jgrid.viewModal("#" + M.themodal,
                                      {gbox: "#gbox_" + n, jqm: b.jqModal, jqM: false, overlay: b
                                          .overlay, modal: b.modal});
                    e()
                } else {
                    var m = isNaN(b.dataheight) ? b.dataheight : b.dataheight + "px";
                    m =
                    a("<form name='FormPost' id='" + j
                    ...
                    t =
                    "<a href='javascript:void(0)' id='" + (c ? "nData" : "pData")
                        + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
                    var J = "<a href='javascript:void(0)' id='" + (c ? "pData" : "nData")
                    ...
                    m =
                    a("<span></span>").append(m).append("<table border='0' class='EditTable' id='"
                                                            + s
                                                            + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"
                                                            + b.labelswidth + "'>" + (c ? J + t : t
                        + J) + "</td><td class='EditButton'>" + u + "</td></tr></tbody></table>");
                    ...
                    a("#" + M.themodal).keydown(function (l) {
                        if (l.which === 27) {
                            A && a.jgrid.hideModal(this, {gb: b.gbox, jqm: b.jqModal, onClose: b
                                .onClose});
                            return false
                        }
                        if (b.navkeys[0] === true) {
                    ...
                    b.closeicon = a.extend([true, "left", "ui-icon-close"], b.closeicon);
                    if (b.closeicon[0] === true)a("#cData", "#" + s + "_2").addClass(b.closeicon[1]
                                                                                         == "right"
                                                                                         ? "fm-button-icon-right"
                                                                                         :
                                                                                     "fm-button-icon-left")
                    ...
                    a.isFunction(b.beforeShowForm) && b.beforeShowForm(a("#" + j));
                    a.jgrid.viewModal("#" + M.themodal,
                                      {gbox: "#gbox_" + n, jqm: b.jqModal, modal: b.modal});
                    ...
                    a("#cData", "#" + s + "_2").click(function () {
                        a.jgrid.hideModal("#" + M.themodal,
                                          {gb: "#gbox_" + n, jqm: b.jqModal, onClose: b.onClose});
                        return false
                    });
        ...
        b =
        a
            .extend({top: 0, left: 0, width: 240, height: "auto", dataheight: "auto", modal: false, overlay: 30, drag: true, resize: true, url: "", mtype: "POST", reloadAfterSubmit: true,
                        beforeShowForm: null, beforeInitData: null, afterShowForm: null, beforeSubmit: null, onclickSubmit: null, afterSubmit: null, jqModal: true, closeOnEscape: false, delData: {}, delicon:
                [], cancelicon: [
            ], onClose: null, ajaxDelOptions: {}, processing: false, serializeDelData: null, useDataProxy: false},
                    a.jgrid.del, b || {});
        d[a(this)[0].p.id] = b;
        return this.each(function () {
            var e = this;
            if (e.grid)if (f) {
                var q = a.isFunction(d[e.p.id].beforeShowForm), x = a.isFunction(d[e.p.id]
                                                                                     .afterShowForm), G = a
                                                                                                              .isFunction(d[e
                    .p.id].beforeInitData) ? d[e.p.id].beforeInitData :
                                                                                                          false, B = e
                    .p.id, w = {}, n = true, j = "DelTbl_" + B, s, M, c, t, o = {themodal: "delmod"
                    + B, modalhead: "delhd" + B, modalcontent: "delcnt" + B, scrollelm: j};
                ...
                if (a("#" + o.themodal).html() !== null) {
                    ...
                    a.jgrid.viewModal("#" + o.themodal,
                                      {gbox: "#gbox_" + B, jqm: d[e.p.id]
                                          .jqModal, jqM: false, overlay: d[e.p.id]
                                          .overlay, modal: d[e.p.id].modal})
                } else {
                    var i = isNaN(d[e.p.id].dataheight) ? d[e.p.id].dataheight : d[e.p.id]
                                                                                     .dataheight
                        + "px";
                    i =
                    "<div id='" + j
                    ...
                    i += "</tbody></table></div>";
                    i +=
                    "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + j
                    ...
                    if (b.delicon[0] === true)a("#dData",
                                                "#" + j + "_2").addClass(b.delicon[1] == "right"
                                                                             ? "fm-button-icon-right"
                                                                             : "fm-button-icon-left")
                        .append("<span class='ui-icon " + b.delicon[2] + "'></span>");
                    if (b.cancelicon[0] === true)a("#eData", "#" + j + "_2").addClass(b
                                                                                          .cancelicon[1]
                                                                                          == "right"
                                                                                          ? "fm-button-icon-right"
                                                                                          : "fm-button-icon-left")
                        .append("<span class='ui-icon " + b.cancelicon[2] + "'></span>");
                    a("#dData", "#" + j + "_2").click(function () {
                        var m = [true, ""];
                        w = {};
                        var H = a("#DelData>td", "#" + j).text();
                        if (a.isFunction(d[e.p.id].onclickSubmit))w =
                                                                  d[e.p.id].onclickSubmit(d[e.p.id],
                                                                                          H) || {};
                        ...
                        if (m[0] && !d[e.p.id].processing) {
                            ...
                            M = c.id;
                            H = H.split(",");
                            for (var J in H)if (H.hasOwnProperty(J))H[J] =
                                                                    a.jgrid.stripPref(e.p.idPrefix,
                                                                                      H[J]);
                            s[M] = H.join();
                            J =
                            a.extend({url: d[e.p.id].url ? d[e.p.id].url : a(e)
                                .jqGrid("getGridParam", "editurl"), type: d[e.p.id].mtype, data: a
                                                                                                     .isFunction(d[e
                                .p.id].serializeDelData) ?
                                                                                                 d[e
                                                                                                     ...
                                                                                                     .id]
                                                                                                     .serializeDelData(s)
                                : s, complete: function (u, C) {
                                if (C != "success") {
                                    m[0] = false;
                                    m[1] =
                                    a.isFunction(d[e.p.id].errorTextFormat) ? d[e.p.id]
                                        .errorTextFormat(u) : C + " Status: '" + u.statusText
                                                                  + "'. Error code: " + u.status
                                } else if (a.isFunction(d[e.p.id].afterSubmit))m =
                                                                               d[e.p.id]
                                                                                   .afterSubmit(u,
                                                                                                s);
                                if (m[0] === false) {
                                    ...
                                    if (d[e.p.id].reloadAfterSubmit && e.p.datatype != "local")a(e)
                                        .trigger("reloadGrid"); else {
                                        var A = [];
                                        A = H.split(",");
                                        ...
                                        } else for (var y = 0; y < A.length; y++)a(e)
                                            .jqGrid("delRowData", e.p.idPrefix + A[y]);
                                        e.p.selrow = null;
                                        e.p.selarrrow = []
                                    }
                                    a.isFunction(d[e.p.id].afterComplete)
                                    && setTimeout(function () {
                                ...
                                m[0] && a.jgrid.hideModal("#" + o.themodal,
                                                          {gb: "#gbox_" + B, jqm: b
                                                              .jqModal, onClose: d[e.p.id].onClose})
                            }}, a.jgrid.ajaxOptions, d[e.p.id].ajaxDelOptions);
                            if (!J.url && !d[e.p.id].useDataProxy)if (a.isFunction(e.p
                                                                                       .dataProxy))d[e
                                .p.id].useDataProxy =
                                                                                                   true; else {
                                m[0] = false;
                            ...
                            if (m[0])if (d[e.p.id].useDataProxy) {
                                ...
                                } else a.jgrid.hideModal("#" + o.themodal, {gb: "#gbox_" + B, jqm: b
                                    .jqModal, onClose: d[e.p.id].onClose})
                            } else a.ajax(J)
                        }
                        if (m[0] === false) {
                    ...
                    a("#eData", "#" + j + "_2").click(function () {
                        a.jgrid.hideModal("#" +
                                          o.themodal,
                                          {gb: "#gbox_" + B, jqm: d[e.p.id].jqModal, onClose: d[e.p
                                              .id].onClose});
                        return false
                    });
                    q && d[e.p.id].beforeShowForm(a("#" + j));
                    a.jgrid.viewModal("#" + o.themodal,
                                      {gbox: "#gbox_" + B, jqm: d[e.p.id].jqModal, overlay: d[e.p
                                          .id].overlay, modal: d[e.p.id].modal})
                }
        ...
        b = a.extend({edit: true, editicon: "ui-icon-pencil", add: true, addicon: "ui-icon-plus",
                         del: true, delicon: "ui-icon-trash", search: true, searchicon: "ui-icon-search", refresh: true, refreshicon: "ui-icon-refresh", refreshstate: "firstpage", view: false, viewicon: "ui-icon-document", position: "left", closeOnEscape: true, beforeRefresh: null, afterRefresh: null, cloneToTop: false, alertwidth: 200, alertheight: "auto", alerttop: null, alertleft: null, alertzIndex: null},
                     a.jgrid.nav, b || {});
        return this.each(function () {
            if (!this.nav) {
                ...
                if (!(!n.grid ||
                    ...
                    if (a("#" + w.themodal).html() === null) {
                        ...
                        a.jgrid.createModal(w, "<div>" + b.alerttext
                            + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>",
                                            {gbox: "#gbox_" + n.p
                                                .id, jqModal: true, drag: true, resize: true, caption: b
                                                .alertcap, top: b.alerttop, left: b
                                                .alertleft, width: b.alertwidth, height: b
                                                .alertheight, closeOnEscape: b
                                                .closeOnEscape, zIndex: b.alertzIndex}, "", "",
                                            true)
                    }
                    var s = 1;
                    ...
                    for (var M = 0; M < s; M++) {
                        ...
                        if (b.add) {
                            ...
                            a(j).append("<div class='ui-pg-div'><span class='ui-icon " + b.addicon
                                            + "'></span>" + b.addtext + "</div>");
                            a("tr", c).append(j);
                            a(j, c).attr({title: b.addtitle || "", id: q.id || "add_" + o})
                                .click(function () {
                                a(this).hasClass("ui-state-disabled") || (a.isFunction(b.addfunc)
                                    ? b.addfunc() :
                                                                          a(n).jqGrid("editGridRow",
                                                                                      "new", q));
                                return false
                            }).hover(function () {
                                         a(this).hasClass("ui-state-disabled") || a(this)
                                             .addClass("ui-state-hover")
                                     }, function () {
                                         a(this).removeClass("ui-state-hover")
                                     });
                        ...
                        if (b.edit) {
                            j = a("<td class='ui-pg-button ui-corner-all'></td>");
                            e = e || {};
                            a(j).append("<div class='ui-pg-div'><span class='ui-icon " + b.editicon
                                            + "'></span>" + b.edittext + "</div>");
                            a("tr", c).append(j);
                            a(j, c).attr({title: b.edittitle || "", id: e.id || "edit_" + o})
                                .click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var i =
                                        n.p.selrow;
                                    if (i)a.isFunction(b.editfunc) ? b.editfunc(i) : a(n)
                                        .jqGrid("editGridRow", i, e); else {
                        ...
                        if (b.view) {
                            j = a("<td class='ui-pg-button ui-corner-all'></td>");
                            B = B || {};
                            a(j).append("<div class='ui-pg-div'><span class='ui-icon " + b.viewicon
                                            + "'></span>" + b.viewtext +
                                        "</div>");
                            a("tr", c).append(j);
                            a(j, c).attr({title: b.viewtitle || "", id: B.id || "view_" + o})
                                .click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var i = n.p.selrow;
                                    if (i)a.isFunction(b.viewfunc) ? b.viewfunc(i) : a(n)
                                        .jqGrid("viewGridRow", i, B); else {
                                        a.jgrid.viewModal("#" + w.themodal,
                                                          {gbox: "#gbox_" + n.p.id, jqm: true});
                                        a("#jqg_alrt").focus()
                                    }
                        ...
                        if (b.del) {
                            ...
                            x = x || {};
                            a(j).append("<div class='ui-pg-div'><span class='ui-icon " + b.delicon
                                            + "'></span>" + b.deltext + "</div>");
                            a("tr", c).append(j);
                            a(j, c).attr({title: b.deltitle || "", id: x.id || "del_" + o})
                                .click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var i;
                                    if (n.p.multiselect) {
                                    ...
                                    if (i)"function" == typeof b.delfunc ? b.delfunc(i) : a(n)
                                        .jqGrid("delGridRow", i, x); else {
                        ...
                        if (b.add || b.edit || b.del || b.view)a("tr", c)
                            .append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");
                        if (b.search) {
                            j = a("<td class='ui-pg-button ui-corner-all'></td>");
                            G = G || {};
                            a(j).append("<div class='ui-pg-div'><span class='ui-icon " + b
                                .searchicon +
                                        "'></span>" + b.searchtext + "</div>");
                            a("tr", c).append(j);
                            a(j, c).attr({title: b.searchtitle || "", id: G.id || "search_" + o})
                                .click(function () {
                        ...
                        if (b.refresh) {
                            ...
                            a("tr", c).append(j);
                            a(j, c).attr({title: b.refreshtitle || "", id: "refresh_" + o})
                                .click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
        ...
        b =
        a
            .extend({caption: "newButton", title: "", buttonicon: "ui-icon-newwin", onClickButton: null, position: "last", cursor: "pointer"},
                    b || {});
        return this.each(function () {
            if (this.grid) {
                if (f.indexOf("#") !== 0)f = "#" + f;
                ...
                if (e)if (!(b.id && a("#" + b.id, e).html() !== null)) {
                    var x = a("<td></td>");
                    b.buttonicon.toString().toUpperCase() == "NONE" ? a(x)
                        .addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>" +
                                                                       b.caption + "</div>") : a(x)
                        .addClass("ui-pg-button ui-corner-all")
                        .append("<div class='ui-pg-div'><span class='ui-icon " + b.buttonicon
                                    + "'></span>" + b.caption + "</div>");
                    b.id && a(x).attr("id", b.id);
                    if (b.position == "first")e.rows[0].cells.length === 0 ? a("tr", e).append(x)
                        : a("tr td:eq(0)", e).before(x); else a("tr", e).append(x);
                    a(x, e).attr("title", b.title || "").click(function (G) {
                        a(this).hasClass("ui-state-disabled") || a.isFunction(b.onClickButton) && b
                            .onClickButton.call(q, G);
                        return false
                    }).hover(function () {
        ...
        return this.each(function () {
            ...
            if (e.grid) {
                ...
                if (q)for (var x in q)a("[name=" + a.jgrid.jqID(x) + "]", b).is("input:radio")
                                          || a("[name=" + a.jgrid.jqID(x) + "]", b)
                                          .is("input:checkbox") ? a("[name=" + a.jgrid.jqID(x)
                                                                        + "]", b).each(function () {
                    if (a(this).val() == q[x])a(this)[e.p.useProp ? "prop" : "attr"]("checked",
                                                                                     true); else a(this)[e
                                                                                                             .p
                                                                                                             .useProp
                        ? "prop" : "attr"]("checked", false)
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                if (e == "add")a(this).jqGrid("addRowData", f, G, q); else e == "set" && a(this)
                    .jqGrid("setRowData", f, G)
            }
        })
    }})
})(jQuery);
(function (c) {
    c.fn.jqFilter = function (k) {
        ...
        var o = c.extend(true, {filter: null, columns: [
        ], onChange: null, afterRedraw: null, checkValues: null, error: false, errmsg: "", errorcheck: true, showQuery: true, sopt: null, ops:
            [
            ...
            ], numopts: ["eq", "ne", "lt", "le", "gt", "ge", "nu", "nn", "in", "ni"], stropts: [
            "eq", "ne", "bw", "bn", "ew", "en", "cn", "nc", "nu", "nn", "in", "ni"], _gridsopt: [
        ], groupOps: [
            {op: "AND", text: "AND"},
            {op: "OR", text: "OR"}
            ...
            if (!this.filter) {
                ...
                if (this.p.filter === null || this.p.filter ===
                                              undefined)this.p.filter =
                                                        {groupOp: this.p.groupOps[0].op, rules: [
                                                        ], groups: []};
                var q, x = this.p.columns.length, j, y = /msie/i.test(navigator.userAgent)
                    && !window.opera;
                if (this.p._gridsopt.length)for (q = 0; q < this.p._gridsopt.length; q++)this.p
                                                                                             .ops[q]
                                                                                             .description =
                                                                                         this.p
                                                                                             ._gridsopt[q];
                ...
                if (x) {
                    for (q = 0; q < x; q++) {
                        j = this.p.columns[q];
                        if (j.stype)j.inputtype = j.stype; else if (!j.inputtype)j.inputtype =
                                                                                 "text";
                        if (j.sorttype)j.searchtype = j.sorttype; else if (!j.searchtype)j
                                                                                             .searchtype =
                                                                                         "string";
                    ...
                    var z = function (d, g) {
                        ...
                        if (c.isFunction(g.searchrules))a =
                                                        g.searchrules(d, g); else if (c.jgrid && c
                            .jgrid.checkValues)try {
                    ...
                    this.onchange = function () {
                        this.p.error = false;
                        this.p.errmsg = "";
                        return c.isFunction(this.p.onChange) ? this.p.onChange.call(this, this.p)
                            : false
                    };
                    ...
                    this.createTableForGroup = function (d, g) {
                        ...
                        if (this.p.ruleButtons === true) {
                            ...
                            for (b = 0; b < o.groupOps.length; b++) {
                                ...
                                f +=
                                "<option value='" + a.p.groupOps[b].op + "'" + l + ">" + a.p
                                    .groupOps[b].text + "</option>"
                            }
                        ...
                        if (this.p.groupButton) {
                            f =
                            c("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>");
                        ...
                        if (this.p.ruleButtons === true) {
                            f =
                            c("<input type='button' value='+' title='Add rule' class='add-rule ui-add'/>");
                            var m;
                            f.bind("click", function () {
                                if (d.rules === undefined)d.rules = [];
                                for (b = 0; b < a.p.columns.length; b++) {
                                    var n = typeof a.p.columns[b].search === "undefined" ? true : a
                                        .p.columns[b].search, s = a.p.columns[b].hidden === true;
                                    if (a.p.columns[b].searchoptions.searchhidden === true && n || n
                                        && !s) {
                                        m = a.p.columns[b];
                                        break
                                    }
                                ...
                                d.rules.push({field: m.name, op: (m.searchoptions.sopt ?
                                                                  m.searchoptions.sopt : a.p.sopt
                                    ? a.p.sopt : m.searchtype === "string" ? a.p.stropts : a.p
                                    .numopts)[0], data: ""});
                                a.reDraw();
                                return false
                            });
                        ...
                        if (g !== null) {
                            f =
                            c("<input type='button' value='-' title='Delete group' class='delete-group'/>");
                            i.append(f);
                            f.bind("click", function () {
                        ...
                        if (d.rules !== undefined)for (b = 0; b < d.rules.length; b++)e.append(this
                                                                                                   .createTableRowForRule(d
                                                                                                                              .rules[b],
                                                                                                                          d));
                        return e
                    };
                    this.createTableRowForRule = function (d, g) {
                        ...
                        s.bind("change",
                               function () {
                                   ...
                                   for (e = 0; e < a.p.columns.length; e++)if (a.p.columns[e].name
                                       === d.field) {
                                       h = a.p.columns[e];
                                       break
                                   }
                                   if (h) {
                                       ...
                                       if (y && h.inputtype === "text")if (!h.searchoptions.size)h
                                                                                                     .searchoptions
                                                                                                     .size =
                                                                                                 10;
                                       var r = c.jgrid.createEl(h.inputtype, h.searchoptions, "",
                                                                true, a.p.ajaxSelectOptions, true);
                                       c(r).addClass("input-elm");
                                       i =
                                       h.searchoptions.sopt ? h.searchoptions.sopt : a.p.sopt ? a.p
                                           .sopt : h.searchtype === "string" ? a.p.stropts : a.p
                                           .numopts;
                                       var u = "",
                                           A = 0;
                                       t = [];
                                       ...
                                       for (e = 0; e < i.length; e++) {
                                           ...
                                           if (p !== -1) {
                                               ...
                                               u +=
                                               "<option value='" + a.p.ops[p].name + "'>" + a.p
                                                   .ops[p].description + "</option>";
                                               A++
                                           }
                                       }
                                       ...
                                       if (c.browser.msie && c.browser.version < 9) {
                                           u =
                                           parseInt(c("select.selectopts", f)[0].offsetWidth) + 1;
                        ...
                        for (e = n = 0; e < a.p.columns.length; e++) {
                            m =
                            typeof a.p.columns[e].search === "undefined" ? true : a.p.columns[e]
                                .search;
                            var C = a.p.columns[e].hidden === true;
                            if (a.p.columns[e].searchoptions.searchhidden === true && m || m
                                && !C) {
                                m = "";
                                ...
                                l +=
                                "<option value='" + a.p.columns[e].name + "'" + m + ">" + a.p
                                    .columns[e].label + "</option>"
                            }
                        }
                        s.append(l);
                        ...
                        h = o.columns[n];
                        h.searchoptions.id = c.jgrid.randId();
                        if (y && h.inputtype === "text")if (!h.searchoptions.size)h.searchoptions
                                                                                      .size = 10;
                        n =
                        c.jgrid.createEl(h.inputtype, h.searchoptions, d.data, true,
                        ...
                        i =
                        h.searchoptions.sopt ? h.searchoptions.sopt : a.p.sopt ? a.p.sopt : h
                                                                                                .searchtype
                                                                                                === "string"
                            ? o.stropts : a.p.numopts;
                        l = "";
                        c.each(a.p.ops, function () {
                            t.push(this.name)
                        });
                        for (e = 0; e < i.length; e++) {
                            ...
                            if (p !== -1) {
                                ...
                                l +=
                                "<option value='" + a.p.ops[p].name + "'" + m + ">" + a.p.ops[p]
                                    .description + "</option>"
                            }
                        }
                        v.append(l);
                        ...
                        if (this.p.ruleButtons === true) {
                            n =
                            c("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>");
                            l.append(n);
                    ...
                    this.getStringForRule = function (d) {
                        ...
                        for (b = 0; b < this.p.columns.length; b++)if (this.p.columns[b].name === d
                            .field) {
                            e = this.p.columns[b];
                            break
                        }
                        ...
                        return c.inArray(e.searchtype,
                                         ["int", "integer", "float", "number", "currency"]) !== -1
                                   || a === "nn" || a === "nu" ? d.field + " " + g + " " + b : d
                                                                                                   .field
                                                                                                   + " "
                                                                                                   + g
                                                                                                   + ' "'
                        ...
                        function d(a) {
                            ...
                            if (a.rules !== undefined)for (e = 0; e < a.rules.length; e++) {
                                ...
                                if (g.p.errorcheck) {
                                    ...
                                    for (f = 0; f < g.p.columns.length; f++)if (g.p.columns[f].name
                                        === i.field) {
                                        h =
                                        g.p.columns[f];
                                        break
...
(function (a) {
    ...
    a.jgrid.extend({editRow: function (c, d, b, i, q, l, s, m, t) {
        var h = {keys: d || false, oneditfunc: b || null, successfunc: i || null, url: q
            || null, extraparam: l || {}, aftersavefunc: s || null, errorfunc: m
            || null, afterrestorefunc: t || null, restoreAfterError: true, mtype: "POST"}, u = a
            .makeArray(arguments).slice(1), e;
        e =
        u[0] && typeof u[0] == "object" && !a.isFunction(u[0]) ? a.extend(a.jgrid.inlineEdit, h,
                                                                          u[0]) : h;
        return this.each(function () {
            ...
            if (g.grid) {
                p = a(g).jqGrid("getInd",
                                c, true);
                if (p !== false)if ((a(p).attr("editable") || "0") == "0" && !a(p)
                    .hasClass("not-editable-row")) {
                    j = g.p.colModel;
                    a('td[role="gridcell"]', p).each(function (k) {
                        f = j[k].name;
                        var A = g.p.treeGrid === true && f == g.p.ExpandColumn;
                        if (A)o = a("span:first", this).html(); else try {
                            o = a.unformat(this, {rowId: c, colModel: j[k]}, k)
                        } catch (r) {
                            o =
                            j[k].edittype && j[k].edittype == "textarea" ? a(this).text() : a(this)
                                .html()
                        }
                        if (f != "cb" && f != "subgrid" && f != "rn") {
                            if (g.p.autoencode)o = a.jgrid.htmlDecode(o);
                            w[f] = o;
                            if (j[k].editable === true) {
                                ...
                                if (o == "&nbsp;" || o == "&#160;" || o.length == 1 && o
                                    ...
                                    == 160)o = "";
                                n =
                                a.jgrid.createEl(j[k].edittype, n, o, true,
                                                 a.extend({}, a.jgrid.ajaxOptions,
                                                          g.p.ajaxSelectOptions || {}));
                                a(n).addClass("editable");
                                A ? a("span:first", this).append(n) : a(this).append(n);
                                j[k].edittype == "select" && typeof j[k].editoptions !== "undefined"
                                    && j[k].editoptions.multiple === true && typeof j[k].editoptions
                                    .dataUrl ===
                                                                             "undefined" && a
                                    .browser.msie && a(n).width(a(n).width());
                                x++
                            }
                        }
                    });
        ...
        var m = {successfunc: d || null, url: b || null,
            extraparam: i || {}, aftersavefunc: q || null, errorfunc: l || null, afterrestorefunc: s
                || null, restoreAfterError: true, mtype: "POST"}, t = a.makeArray(arguments)
            .slice(1), h;
        h =
        t[0] && typeof t[0] == "object" && !a.isFunction(t[0]) ? a.extend(a.jgrid.inlineEdit, m,
                                                                          t[0]) : m;
        ...
        if (m === "1") {
            ...
            a('td[role="gridcell"]', p).each(function (r) {
                j = e.p.colModel[r];
                g = j.name;
                if (g != "cb" && g != "subgrid" && j.editable === true && g != "rn" && !a(this)
                    .hasClass("not-editable-cell")) {
                    switch (j.edittype) {
                        case "checkbox":
                            var n = ["Yes", "No"];
                            if (j.editoptions)n = j.editoptions.value.split(":");
                        ...
                        case "select":
                            ...
                            if (j.formatter && j.formatter == "select")o = {};
                            break;
                        case "custom":
                            try {
                                if (j.editoptions && a.isFunction(j.editoptions.custom_value)) {
                                    f[g] =
                                    j.editoptions.custom_value.call(e, a(".customelement", this),
                                                                    "get");
                                    if (f[g] === undefined)throw"e2";
                                } else throw"e1";
                            } catch (z) {
                                z == "e1" && a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,
                                                                 "function 'custom_value' " + a
                                                                     .jgrid.edit.msg.nodefined,
                                                                 jQuery.jgrid.edit.bClose);
                                z == "e2" ? a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,
                                                                "function 'custom_value' " + a.jgrid
                                                                    .edit.msg.novalue,
                                                                jQuery.jgrid.edit.bClose) : a.jgrid
                                    .info_dialog(jQuery.jgrid.errors.errcap, z.message,
                                                 jQuery.jgrid.edit.bClose)
                            }
                    }
                    ...
                    if (e.p.autoencode)f[g] = a.jgrid.htmlEncode(f[g]);
                    if (h.url !== "clientArray" && j.editoptions && j.editoptions.NullIfEmpty
                        === true)if (f[g] === "")x[g] = "null"
                }
            });
            if (w[0] === false) {
                try {
            ...
            if (f) {
                f[t] = m.editoper;
                f[k] = c;
                if (typeof e.p.inlineData == "undefined")e.p.inlineData = {};
            ...
            if (h.url == "clientArray") {
                ...
                a(p).attr("editable", "0");
                for (m = 0; m < e.p.savedRow.length; m++)if (e.p.savedRow[m].id ==
                                                             c) {
                    y = m;
                    break
                }
                ...
                a.ajax(a.extend({url: h.url, data: a.isFunction(e.p.serializeRowData) ? e.p
                    .serializeRowData.call(e, x) : x, type: h
                    .mtype, async: false, complete: function (r, n) {
                    a("#lui_" + e.p.id).hide();
                    if (n === "success") {
                        var v = true, z;
                        ...
                        if (v === true) {
                            ...
                            a(p).attr("editable", "0");
                            for (v = 0; v < e.p.savedRow.length; v++)if (e.p.savedRow[v].id == c) {
                                y = v;
                                break
                            }
                            y >= 0 && e.p.savedRow.splice(y, 1);
                            ...
                            h.restoreAfterError === true && a(e).jqGrid("restoreRow", c,
                                                                        h.afterrestorefunc)
                        }
                    }
                },
                                    error: function (r, n) {
                                        a("#lui_" + e.p.id).hide();
                                        if (a.isFunction(h.errorfunc))h.errorfunc.call(e, c, r,
                                                                                       n); else try {
        ...
        var b = {afterrestorefunc: d || null}, i = a.makeArray(arguments).slice(1),
            q;
        q =
        i[0] && typeof i[0] == "object" && !a.isFunction(i[0]) ? a.extend(a.jgrid.inlineEdit, b,
                                                                          i[0]) : b;
        return this.each(function () {
            var l = this, s, m, t = {};
            if (l.grid) {
                ...
                if (m !== false) {
                    for (var h = 0; h < l.p.savedRow.length; h++)if (l.p.savedRow[h].id == c) {
                        s = h;
                        break
                    }
                    if (s >= 0) {
                        ...
                        a.each(l.p.colModel, function () {
                            if (this.editable === true && this.name in l.p.savedRow[s] && !a(this)
                                .hasClass("not-editable-cell"))t[this.name] =
                                                               l.p.savedRow[s][this.name]
                        });
                        a(l).jqGrid("setRowData", c, t);
                        a(m).attr("editable", "0").unbind("keydown");
                        l.p.savedRow.splice(s, 1);
                        a("#" + a.jgrid.jqID(c), "#" + a.jgrid.jqID(l.p.id))
                            .hasClass("jqgrid-new-row") && setTimeout(function () {
        ...
        c =
        a
            .extend({rowID: "new_row", initdata: {}, position: "first", useDefValues: false, useFormatter: false, addRowParams: {extraparam: {}}},
                    c || {});
        return this.each(function () {
            if (this.grid) {
                var d =
                ...
                a("#" + a.jgrid.jqID(c.rowID), "#" + a.jgrid.jqID(d.p.id))
                    .addClass("jqgrid-new-row");
                if (c.useFormatter)a("#" + a.jgrid.jqID(c.rowID) + " .ui-inline-edit",
                                     "#" + a.jgrid.jqID(d.p.id)).click(); else {
                    var b = d.p.prmNames;
        ...
        d =
        a
            .extend({edit: true, editicon: "ui-icon-pencil", add: true, addicon: "ui-icon-plus", save: true, saveicon: "ui-icon-disk", cancel: true, cancelicon: "ui-icon-cancel", addParams: {useFormatter: false}, editParams: {}},
                    a.jgrid.nav, d || {});
        return this.each(function () {
            if (this.grid) {
                var b = this;
                if (d.addParams.useFormatter === true) {
                    ...
                    for (q = 0; q < i.length; q++)if (i[q].formatter && i[q].formatter
                        === "actions") {
                        if (i[q].formatoptions) {
                            i =
                            a
                                .extend({keys: false, onEdit: null, onSuccess: null, afterSave: null, onError: null, afterRestore: null, extraparam: {}, url: null},
                                        i[q].formatoptions);
                            d.addParams.addRowParams =
                            {keys: i.keys, oneditfunc: i.onEdit, successfunc: i.onSuccess, url: i
                                .url, extraparam: i.extraparam, aftersavefunc: i
                                .afterSavef, errorfunc: i.onError, afterrestorefunc: i.afterRestore}
                        }
                        break
                    }
                }
                d.add && a(b).jqGrid("navButtonAdd", c,
                                     {caption: d.addtext, title: d.addtitle, buttonicon: d
                                         .addicon, id: b.p.id
                                         + "_iladd", onClickButton: function () {
                ...
                d.edit && a(b).jqGrid("navButtonAdd", c,
                                      {caption: d.edittext, title: d.edittitle, buttonicon: d
                                          .editicon, id: b.p.id
                                          + "_iledit", onClickButton: function () {
                                          ...
                                          if (l) {
                                              ...
                                              a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" + b.p
                                                  .id, jqm: true});
                                              a("#jqg_alrt").focus()
                                          }
                                      }});
                if (d.save) {
                    a(b).jqGrid("navButtonAdd", c, {caption: d.savetext || "", title: d.savetitle
                        || "Save row", buttonicon: d.saveicon, id: b.p.id
                        + "_ilsave", onClickButton: function () {
                        var l = a(b).jqGrid("getGridParam", "selrow");
                        if (l) {
                            if (a("#" + a.jgrid.jqID(l), "#" + a.jgrid.jqID(b.p.id))
                                .hasClass("jqgrid-new-row")) {
                                var s =
                                    b.p.prmNames, m = s.oper;
                ...
                if (d.cancel) {
                    a(b).jqGrid("navButtonAdd",
                                c, {caption: d.canceltext || "", title: d.canceltitle
                            || "Cancel row editing", buttonicon: d.cancelicon, id: b.p.id
                            + "_ilcancel", onClickButton: function () {
                            var l = a(b).jqGrid("getGridParam", "selrow");
                            if (l) {
                                ...
                                a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" +
                                                                      b.p.id, jqm: true});
                                a("#jqg_alrt").focus()
                            }
                        }});
    ...
    b.jgrid.extend({editCell: function (d, f, a) {
            ...
            if (!(!c.grid || c.p.cellEdit !== true)) {
                ...
                if (!(h == "subgrid" || h == "cb" || h == "rn")) {
                    ...
                    if (i.editable === true && a === true && !g.hasClass("not-editable-cell")) {
                        ...
                        if (e == "&nbsp;" || e == "&#160;" || e.length == 1 && e.charCodeAt(0)
                            == 160)e = "";
                        ...
                        b.isFunction(c.p.beforeEditCell) && c.p.beforeEditCell.call(c, c.rows[d].id,
                                                                                    h, e,
                                                                                    d, f);
                        ...
                        b("input, select, textarea", g).bind("keydown", function (l) {
                            if (l.keyCode === 27)if (b("input.hasDatepicker", g).length
                                > 0)b(".ui-datepicker").is(":hidden") ? b(c).jqGrid("restoreCell",
                                                                                    d, f)
                                : b("input.hasDatepicker", g).datepicker("hide"); else b(c)
                                .jqGrid("restoreCell", d, f);
                            l.keyCode === 13 && b(c).jqGrid("saveCell", d, f);
                            if (l.keyCode == 9)if (c.grid.hDiv.loading)return false; else l.shiftKey
                                ? b(c).jqGrid("prevCell", d, f) : b(c).jqGrid("nextCell",
                                                                              d, f);
                            l.stopPropagation()
                        });
                        b.isFunction(c.p.afterEditCell) && c.p.afterEditCell.call(c, c.rows[d].id,
                                                                                  h, e, d, f)
                    } else {
                        if (parseInt(c.p.iCol, 10) >= 0 && parseInt(c.p.iRow, 10) >= 0) {
                            b("td:eq(" + c.p.iCol + ")", c.rows[c.p.iRow])
        ...
        return this.each(function () {
            ...
            if (!(!a.grid || a.p.cellEdit !== true)) {
                ...
                if (c !== null) {
                    var h = b("td:eq(" + f + ")", a.rows[d]), e, g, i = a.p.colModel[f], k = i
                        .name, j = b.jgrid.jqID(k);
                    switch (i.edittype) {
                        case "select":
                        ...
                        case "custom":
                            try {
                                if (i.editoptions && b.isFunction(i.editoptions.custom_value)) {
                                    e =
                                    i.editoptions.custom_value.call(a, b(".customelement", h),
                                                                    "get");
                                    if (e === undefined)throw"e2"; else g = e
                                } else throw"e1";
                            } catch (q) {
                                q == "e1" && b.jgrid.info_dialog(jQuery.jgrid.errors.errcap,
                                                                 "function 'custom_value' " + b
                                                                     .jgrid.edit.msg.nodefined,
                                                                 jQuery.jgrid.edit.bClose);
                                q == "e2" ? b.jgrid.info_dialog(jQuery.jgrid.errors.errcap,
                                                                "function 'custom_value' " + b.jgrid
                                                                    .edit.msg.novalue,
                                                                jQuery.jgrid.edit.bClose) : b.jgrid
                                    .info_dialog(jQuery.jgrid.errors.errcap, q.message,
                                                 jQuery.jgrid.edit.bClose)
                            }
                    }
                    if (g !== a.p.savedRow[c].v) {
                        ...
                        if (r[0] === true) {
                            c = {};
                            if (b.isFunction(a.p.beforeSubmitCell))(c =
                                                                    a.p.beforeSubmitCell.call(a, a
                                                                        .rows[d].id, k, e, d, f))
                            || (c = {});
                            b("input.hasDatepicker", h).length > 0 && b("input.hasDatepicker", h)
                                .datepicker("hide");
                            if (a.p.cellsubmit == "remote")if (a.p.cellurl) {
                                ...
                                b("#lui_" + a.p.id).show();
                                a.grid.hDiv.loading = true;
                                b.ajax(b.extend({url: a.p.cellurl, data: b.isFunction(a.p
                                                                                          .serializeCellData)
                                    ? a.p.serializeCellData.call(a, n)
                                    : n, type: "POST", complete: function (o, p) {
                                    b("#lui_" + a.p.id).hide();
                                    a.grid.hDiv.loading = false;
                                    if (p == "success")if (b.isFunction(a.p.afterSubmitCell)) {
                                        ...
                                        if (s[0] === true) {
                                            b(h).empty();
                                            b(a).jqGrid("setCell", a.rows[d].id, f, g, false, false,
                                                        true);
                                            ...
                                            b.jgrid.info_dialog(b.jgrid.errors.errcap, s[1],
                                                                b.jgrid.edit.bClose);
                                    ...
                                    a.p.errorCell.call(a, o, p) : b.jgrid.info_dialog(b.jgrid.errors
                                                                                          .errcap,
                                                                                      o.status
                                                                                          + " : "
                                                                                          + o
                            ...
                            window.setTimeout(function () {
                                b.jgrid.info_dialog(b.jgrid.errors.errcap, e + " " + r[1],
                                                    b.jgrid.edit.bClose)
                            }, 100);
                            b(a).jqGrid("restoreCell", d, f)
                        } catch (u) {
                ...
                b.browser.opera ? b("#" + a.p.knv).attr("tabindex", "-1").focus() : window
                    .setTimeout(function () {
        ...
        return this.each(function () {
            ...
            if (!(!a.grid || a.p.cellEdit !== true)) {
                ...
                if (c !== null) {
                    ...
                    b.isFunction(a.p.afterRestoreCell) && a.p.afterRestoreCell.call(a, a.rows[d].id,
                                                                                    a.p.savedRow[c]
                                                                                        .v, d, f);
                    a.p.savedRow.splice(0, 1)
                }
        ...
        return this.each(function () {
            ...
            if (!(!this.grid || this.p.cellEdit !== true)) {
                for (var c = f + 1; c < this.p.colModel.length; c++)if (this.p.colModel[c].editable
                    === true) {
                    a = c;
                    break
                }
                if (a !== false)b(this).jqGrid("editCell", d, a, true); else this.p.savedRow.length
                                                                                 > 0 && b(this)
                                                                                 .jqGrid("saveCell",
                                                                                         d, f)
            }
        ...
        return this.each(function () {
            function d(g, i, k) {
                if (k.substr(0, 1) == "v") {
                    var j = b(a.grid.bDiv)[0].clientHeight, m = b(a.grid.bDiv)[0].scrollTop, l = a
                                                                                                     .rows[g]
                                                                                                     .offsetTop
                        + a.rows[g].clientHeight, q = a.rows[g].offsetTop;
                    if (k == "vd")if (l >= j)b(a.grid.bDiv)[0].scrollTop =
                                             b(a.grid.bDiv)[0].scrollTop + a.rows[g].clientHeight;
                    if (k == "vu")if (q < m)b(a.grid.bDiv)[0].scrollTop =
                ...
                if (k == "h") {
                    ...
                    if (a.rows[g].cells[i].offsetLeft + a.rows[g].cells[i].clientWidth >= k
                        + parseInt(j, 10))b(a.grid.bDiv)[0].scrollLeft =
                                          b(a.grid.bDiv)[0].scrollLeft + a.rows[g].cells[i]
                                              .clientWidth; else if (m < j)b(a.grid.bDiv)[0]
                                                                               .scrollLeft =
                                                                           b(a.grid.bDiv)[0]
                                                                               .scrollLeft - a
                                                                               .rows[g].cells[i]
            ...
            if (!(!a.grid || a.p.cellEdit !== true)) {
                ...
                b("#" + a.p.knv).focus().keydown(function (g) {
                    ...
                    switch (e) {
                        ...
                        case 13:
                            parseInt(a.p.iCol,
                                     10) >= 0 && parseInt(a.p.iRow, 10) >= 0 && b(a)
                                .jqGrid("editCell", a.p.iRow, a.p.iCol, true);
                            break;
                        default:
                            return true
                    }
                ...
                if (b(this).hasClass("edited")) {
                    b("td", this).each(function (g) {
                        ...
                        if (c !== "cb" && c !== "subgrid")if (d == "dirty") {
                            ...
                            e[c] =
                            b.unformat(this, {rowId: a.rows[h].id, colModel: a.p.colModel[g]}, g)
                        } catch (k) {
                            e[c] = b.jgrid.htmlDecode(b(this).html())
                        }
                    });
...
(function (b) {
    ...
    b.jqm = {hash: {}, open: function (a, f) {
        ...
        g = g > 0 ? g : 3E3;
        var h = b("<div></div>")
            .css({height: "100%", width: "100%", position: "fixed", left: 0, top: 0, "z-index": g
            - 1, opacity: d.overlay / 100});
        if (c.a)return e;
        c.t = f;
        c.a = true;
        c.w.css("z-index", g);
        ...
        if (q) {
            ...
            if (h) {
                ...
                for (var m in{Top: 1, Left: 1})h.style.setExpression(m.toLowerCase(),
    ...
    var l =
        0, j = b.jqm.hash, k = [], q = b.browser.msie && b.browser.version
        == "6.0", e = false, r = function (a) {
        var f = b('<iframe src="javascript:false;document.write(\'\');" class="jqm"></iframe>')
            .css({opacity: 0});
        if (q)if (a.o)a.o.html('<p style="width:100%;height:100%"/>')
            .prepend(f); else b("iframe.jqm", a.w)[0] || a.w.prepend(f);
        s(a)
    }, s = function (a) {
        try {
            ...
            b(f).each(function () {
                if (!this[c]) {
                    ...
                    b(this).click(function () {
                        for (var i in{jqmShow: 1, jqmHide: 1})for (var g in
                            this[i])if (j[this[i][g]])j[this[i][g]].w[i](this);
                        return e
                    })
                }
                this[c].push(d)
...
(function (b) {
    ...
    b.jqDnR = {dnr: {}, e: 0, drag: function (a) {
        if (c.k == "d")d.css({left: c.X + a.pageX - c.pX, top: c.Y + a.pageY - c.pY}); else {
            d.css({width: Math.max(a.pageX - c.pX + c.W, 0), height: Math.max(a.pageY - c.pY + c.H,
                                                                              0)});
            M1 && f.css({width: Math.max(a.pageX - M1.pX + M1.W, 0), height: Math.max(a.pageY - M1
                .pY + M1.H, 0)})
        }
        return false
    }, stop: function () {
        ...
        d = i.e, f, l = function (a, e, n, m) {
            return a.each(function () {
                ...
                e.bind("mousedown", {e: a, k: n}, function (g) {
                    ...
                    c =
                    {X: h.left || k("left") || 0, Y: h.top || k("top") || 0, W: k("width") || d[0]
                        .scrollWidth || 0, H: k("height") || d[0].scrollHeight || 0, pX: g
                        .pageX, pY: g.pageY, k: j.k};
                    M1 =
                    f && j.k != "d" ? {X: h.left || f1("left") || 0, Y: h.top || f1("top")
                        || 0, W: f[0].offsetWidth || f1("width") || 0, H: f[0].offsetHeight
                                                                              || f1("height")
                        || 0, pX: g.pageX, pY: g.pageY,
                        k: j.k} : false;
...
(function (b) {
    b.jgrid.extend({setSubGrid: function () {
        return this.each(function () {
            ...
            b
                .extend({plusicon: "ui-icon-plus", minusicon: "ui-icon-minus", openicon: "ui-icon-carat-1-sw", expandOnLoad: false, delayOnLoad: 50, selectOnExpand: false, reloadOnExpand: true},
                        this.p.subGridOptions || {});
            this.p.colNames.unshift("");
            this.p.colModel.unshift({name: "subgrid", width: b.browser.safari ? this.p.subGridWidth
                + this.p.cellLayout : this.p
                                                                 .subGridWidth, sortable: false, resizable: false, hidedlg: true, search: false,
                                        fixed: true});
        ...
        return'<td role="grid" aria-describedby="' + s
                  ...
                  + "><a href='javascript:void(0);'><span class='ui-icon " + n
            + "'></span></a></td>"
            ...
            if (a.grid) {
                var n = function (g, j, e) {
                    ...
                    for (c = 0; c < a.p.subGridModel[0].name.length; c++) {
                        e =
                        b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + a.p
                            .direction + "'></th>");
                    ...
                    if (g) {
                        ...
                        b(h.root + " " + h.row, g).each(function () {
                            ...
                            if (h.repeatitems === true)b(h.cell, this).each(function (m) {
                                ...
                                if (o)for (c = 0; c < o.length; c++)n(i, b(o[c], this).text()
                                    || "&#160;", c)
                            }
                            b(k).append(i)
                        })
                    ...
                    if (g) {
                        ...
                        if (typeof e !== "undefined")for (c = 0; c < e.length; c++) {
                            ...
                            if (k.repeatitems === true) {
                                ...
                                if (u.length)for (i = 0; i < u.length; i++)n(m, h[u[i]] || "&#160;",
                                                                             i)
                            }
                            b(o).append(m)
                        }
                    ...
                    if (a.p.subGridModel[0].params)for (h = 0;
                                                        h < a.p.subGridModel[0].params.length;
                                                        h++)for (c = 0; c < a.p.colModel.length;
                                                                 c++)if (a.p.colModel[c].name == a.p
                                .subGridModel[0].params[h])e[a.p.colModel[c].name] =
                                                           b("td:eq(" + c + ")", g).text()
                                                               .replace(/\&#160\;/ig, "");
                    if (!a.grid.hDiv.loading) {
                        a.grid.hDiv.loading = true;
                        ...
                        if (b.isFunction(a.p.subgridtype))a.p.subgridtype.call(a, e); else a.p
                                                                                               .subgridtype =
                                                                                           a.p
                                                                                               .subgridtype
                                                                                               .toLowerCase();
                        switch (a.p.subgridtype) {
                            ...
                            case "json":
                                b.ajax(b.extend({type: a.p.mtype,
                                                    url: a.p.subGridUrl, dataType: a.p
                                        .subgridtype, data: b.isFunction(a.p.serializeSubGridData)
                                        ? a.p.serializeSubGridData.call(a, e)
                                        : e, complete: function (k) {
                                        a.p.subgridtype == "xml" ? s(k.responseXML, j) : v(b.jgrid
                                                                                               .parse(k
                                                                                                          .responseText),
                                                                                           j)
    ...
    e.jgrid.extend({groupingSetup: function () {
            ...
            if (a !== null && (typeof a === "object" || e.isFunction(a)))if (a.groupField.length) {
                ...
                for (var c = 0; c < a.groupField.length; c++) {
                    ...
                    if (a.groupColumnShow[c] === true) {
                        ...
                        e("#" + this.p.id + "_" + a.groupField[c]).is(":visible");
                    ...
                    if (a.groupSummary[c]) {
                        a.summary[c] = [];
                        for (var b = this.p.colModel, d = 0, g = b.length; d < g; d++)b[d]
                                                                                          .summaryType
                        && a.summary[c].push({nm: b[d].name, st: b[d].summaryType, v: ""})
                    }
                }
                this.p.scroll = false;
        ...
        this.each(function () {
            ...
            h.groupSummary[0] && e.each(h.summaryval[0][g], function () {
                this.v = e.isFunction(this.st) ?
                         this.st.call(f, this.v, this.nm, d) : e(f).jqGrid("groupingCalculations."
                                                                               + this.st, this.v,
                                                                           this.nm, d)
            })
        });
        ...
        return this.each(function () {
            ...
            e.each(d.sortitems[0], function (o, n) {
                f = b.p.id + "ghead_" + o;
                h =
                "<span style='cursor:pointer;' class='ui-icon " + k + "' onclick=\"jQuery('#" + b.p
                    .id + "').jqGrid('groupingToggle','" + f + "');return false;\"></span>";
                try {
                ...
                g +=
                '<tr id="' + f + '" role="row" class= "ui-widget-content jqgroup ui-row-' + b.p
                    .direction + '"><td colspan="' + c + '">' + h + e.jgrid.format(d.groupText[0],
                                                                                   l, a[n].length)
                    + "</td></tr>";
                ...
                if (d.groupSummary[0]) {
                    ...
                    g +=
                    "<tr" + i + ' role="row" class="ui-widget-content jqfoot ui-row-' + b.p
                        .direction + '">';
                    i = d.summaryval[0][n];
                    for (var p = b.p.colModel, q, s = a[n].length, j = 0; j < c; j++) {
                        ...
                        e.each(i, function () {
                            if (this.nm == p[j].name) {
                                ...
                                t =
                                "<td " + b.formatCol(j, 1, "") + ">" + e.jgrid.format(u, q)
                                    + "</td>";
                                return false
                            }
                        });
        ...
        return this.each(function () {
            ...
            var d;
            for (d = 0; d < b.groupField.length; d++)!b.groupColumnShow[d] && b
                .visibiltyOnNextGrouping[d] && e(this).jqGrid("showCol", b.groupField[d]);
            for (d = 0; d < a.length; d++)b.visibiltyOnNextGrouping[d] =
                                          e("#" + this.p.id + "_" + a[d]).is(":visible");
        ...
        return this.each(function () {
            ...
            if (a === true) {
                for (var c =
                    this.p.groupingView, b = 0; b < c.groupField.length; b++)!c.groupColumnShow[b]
                                                                                 && c
                                                                                 .visibiltyOnNextGrouping[b]
...
(function (d) {
    d.jgrid.extend({setTreeNode: function (a, c) {
        return this.each(function () {
            var b = this;
            if (b.grid && b.p.treeGrid)for (var e = b.p.expColInd, g = b.p.treeReader
                .expanded_field, h = b.p.treeReader.leaf_field, f = b.p.treeReader
                .level_field, l = b.p.treeReader.icon_field, i = b.p.treeReader.loaded, j, o, n, k;
                                            a < c;) {
                ...
                n =
                "<div class='tree-wrap tree-wrap-" + b.p.direction + "' style='width:" + n * 18
                    + "px;'>";
                n +=
                "<div style='" + (b.p.direction == "rtl" ? "right:" : "left:") + o * 18
                    + "px;' class='ui-icon ";
                if (k[i] !== undefined)k[i] = k[i] == "true" || k[i] === true ? true : false;
                if (k[h] == "true" || k[h] === true) {
                    n +=
                    (k[l] !== undefined && k[l] !== "" ? k[l] : b.p.treeIcons.leaf)
                        + " tree-leaf treeclick";
                    k[h] = true;
                    o = "leaf"
                } else {
                ...
                k[g] = (k[g] == "true" || k[g] === true ? true : false) &&
                       k[i];
                n +=
                k[g] === false ? k[h] === true ? "'" : b.p.treeIcons.plus + " tree-plus treeclick'"
                    : k[h] === true ? "'" : b.p.treeIcons.minus + " tree-minus treeclick'";
                n += "></div></div>";
                d(b.rows[a].cells[e]).wrapInner("<span class='cell-wrapper" + o + "'></span>")
                    .prepend(n);
                if (j !== parseInt(b.p.tree_root_level, 10))(k =
                                                             (k = d(b).jqGrid("getNodeParent", k))
                ...
                b.p.ExpandColClick === true && d(b.rows[a].cells[e]).find("span.cell-wrapper")
                    .css("cursor", "pointer").bind("click", function (m) {
                    m = d(m.target || m.srcElement, b.rows).closest("tr.jqgrow")[0].id;
                    var r = b.p._index[m];
        ...
        return this.each(function () {
            ...
            if (a.p.treeGrid) {
                ...
                0;
                a.p.treeIcons =
                d.extend({plus: "ui-icon-triangle-1-" + (a.p.direction == "rtl" ? "w"
                    : "e"), minus: "ui-icon-triangle-1-s", leaf: "ui-icon-radio-off"},
                         a.p.treeIcons || {});
                if (a.p.treeGridModel == "nested")a.p.treeReader =
                                                  d
                                                      .extend({level_field: "level", left_field: "lft", right_field: "rgt", leaf_field: "isLeaf", expanded_field: "expanded", loaded: "loaded", icon_field: "icon"},
                                                              a.p.treeReader); else if (a.p
                                                                                            .treeGridModel
                    == "adjacency")a.p.treeReader =
                                   d
                                       .extend({level_field: "level", parent_id_field: "parent", leaf_field: "isLeaf", expanded_field: "expanded",
                ...
                d.each(a.p.treeReader, function (l, i) {
                    if (i && d.inArray(i, h) === -1) {
                        ...
                        a.p.colNames.push(i);
                        a.p.colModel
                            .push({name: i, width: 1, hidden: true, sortable: false, resizable: false, hidedlg: true, editable: true, search: false})
                    }
                })
            }
        })
        ...
        this.each(function () {
            if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                case "nested":
                    c =
                    parseInt(a[this.p.treeReader.level_field], 10) - parseInt(this.p
                                                                                  .tree_root_level,
                                                                              10);
                    break;
                case "adjacency":
        ...
        this.each(function () {
            if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                case "nested":
                    var b = this.p.treeReader.left_field, e = this.p.treeReader
                        .right_field, g = this.p.treeReader.level_field, h = parseInt(a[b],
                                                                                      10), f = parseInt(a[e],
                                                                                                        10), l = parseInt(a[g],
                                                                                                                          10);
                    d(this.p.data).each(function () {
                        if (parseInt(this[g], 10) === l - 1 && parseInt(this[b], 10) < h
            ...
            if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                case "nested":
                    var b = this.p.treeReader.left_field,
                        e = this.p.treeReader.right_field, g = this.p.treeReader
                            .level_field, h = parseInt(a[b], 10), f = parseInt(a[e],
                                                                               10), l = parseInt(a[g],
                                                                                                 10);
                    d(this.p.data).each(function () {
                        parseInt(this[g], 10) === l + 1 && parseInt(this[b], 10) > h
                            && parseInt(this[e], 10) < f && c.push(this)
                    });
                    break;
                case "adjacency":
                    var i = this.p.treeReader.parent_id_field, j = this.p.localReader.id;
        ...
        this.each(function () {
            ...
            if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                case "nested":
                    var e =
                        this.p.treeReader.left_field, g = this.p.treeReader.right_field, h = this.p
                        .treeReader.level_field, f = parseInt(a[e], 10), l = parseInt(a[g],
                                                                                      10), i = parseInt(a[h],
                                                                                                        10);
                    d(this.p.data).each(function () {
                        parseInt(this[h], 10) >= i && parseInt(this[e], 10) >= f
                            && parseInt(this[e], 10) <= l && c.push(this)
                    });
                    break;
                case "adjacency":
                    if (a) {
        ...
        this.each(function () {
            if (this.grid && this.p.treeGrid) {
                ...
                c =
                a !== undefined ? a.loaded !== undefined ? a.loaded : a[b] || d(this)
        ...
        return this.each(function () {
            if (this.grid && this.p.treeGrid) {
                var c = this.p.treeReader.expanded_field, b = this.p.treeReader
                    .parent_id_field, e = this.p.treeReader.loaded, g = this.p.treeReader
                    .level_field, h = this.p.treeReader.left_field, f = this.p.treeReader
                    .right_field;
                if (!a[c]) {
                    var l = d.jgrid.getAccessor(a, this.p.localReader.id), i = d("#" + l, this.grid
                        .bDiv)[0], j = this.p._index[l];
                    if (d(this).jqGrid("isNodeLoaded", this.p.data[j])) {
                        a[c] = true;
                        d("div.treeclick", i).removeClass(this.p.treeIcons.plus + " tree-plus")
                        ...
                        this.p.treeGridModel == "nested" ? d(this).jqGrid("setGridParam",
                                                                          {postData: {nodeid: l, n_left: a[h], n_right: a[f], n_level: a[g]}})
        ...
        return this.each(function () {
            if (this.grid && this.p.treeGrid) {
                ...
                if (a[c]) {
                    ...
                    d("div.treeclick", c).removeClass(this.p.treeIcons.minus + " tree-minus")
        ...
        return this.each(function () {
            var c =
                this.p.localReader.id, b = this.p.treeReader.left_field, e = this.p.treeReader
                .right_field, g, h, f;
            if (this.grid && this.p.treeGrid) {
                ...
                if (l !== undefined) {
                    ...
                    if (l.length > 0)for (var i = 0; i < l.length; i++)d(this).jqGrid("delRowData",
                                                                                      l[i][c]);
        ...
        var e = this[0];
        if (b) {
            var g = e.p.treeReader.expanded_field, h = e.p.treeReader.leaf_field, f = e.p.treeReader
                .level_field, l = e.p.treeReader.parent_id_field, i = e.p.treeReader
                .left_field, j = e.p.treeReader.right_field, o = e.p.treeReader
                .loaded, n, k, m, r, p;
            n = 0;
            var s = c, t;
            ...
            if (c === undefined || c === null || c === "") {
                ...
                if (m[h]) {
                    t = true;
                    m[g] = true;
                    d(e.rows[u]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf")
                        .addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(e.p
                                                                                              .treeIcons
                                                                                              .leaf
                                                                                              +
                                                                                          " tree-leaf")
...
(function (b) {
    b.jgrid.extend({jqGridImport: function (a) {
        a =
        b
            .extend({imptype: "xml", impstring: "", impurl: "", mtype: "GET", impData: {}, xmlGrid: {config: "roots>grid", data: "roots>rows"}, jsonGrid: {config: "grid", data: "data"}, ajaxOptions: {}},
                    a || {});
        return this.each(function () {
            ...
            switch (a.imptype) {
                case "xml":
                    b.ajax(b.extend({url: a.impurl, type: a.mtype, data: a.impData, dataType: "xml",
                                        complete: function (f, g) {
                                            if (g == "success") {
                                                c(f.responseXML, a);
                                                b.isFunction(a.importComplete) && a
                                                    .importComplete(f)
                                            }
                                        }}, a.ajaxOptions));
                    break;
                case "xmlstring":
                    ...
                    break;
                case "json":
                    b.ajax(b.extend({url: a.impurl, type: a.mtype, data: a
                        .impData, dataType: "json", complete: function (f, g) {
                        if (g == "success") {
                            j(f.responseText, a);
        ...
        this.each(function () {
            if (this.grid) {
                ...
                switch (a.exptype) {
                    case "xmlstring":
                        d =
                        "<" + a.root + ">" + xmlJsonClass.json2xml(c, a.ident) + "</" + a.root
                            + ">";
                        break;
                    case "jsonstring":
        ...
        a =
        b.extend({exptype: "remote", url: null, oper: "oper", tag: "excel", exportOptions: {}},
                 a || {});
        return this.each(function () {
            if (this.grid) {
                var d;
...
var xmlJsonClass = {xml2json: function (a, b) {
    ...
    var h = function (d, c, i) {
            var g = "", k, j;
            if (d instanceof Array)if (d.length === 0)g +=
                                                      i + "<" + c + ">__EMPTY_ARRAY_</" + c
                                                          + ">\n"; else {
                k = 0;
                ...
                for (j in d)if (d.hasOwnProperty(j))if (j.charAt(0) ===
                                                        "@")g +=
                                                            " " + j.substr(1) + '="' + d[j]
                                                                .toString() + '"'; else k = true;
                g += k ? ">" : "/>";
                if (k) {
                    for (j in d)if (d.hasOwnProperty(j))if (j === "#text")g += d[j]; else if (j
                        === "#cdata")g += "<![CDATA[" + d[j] + "]]\>"; else if (j.charAt(0)
                        !== "@")g += h(d[j], j, i + "\t");
                    g += (g.charAt(g.length - 1) === "\n" ? i : "") + "</" + c + ">"
                }
            } else if (typeof d === "function")g +=
                                               i + "<" + c + "><![CDATA[" + d + "]]\></" + c
                                                   + ">"; else {
                if (d === undefined)d = "";
                g +=
                d.toString() === '""' || d.toString().length === 0 ? i + "<" + c
                                                                         + ">__EMPTY_STRING_</" + c
                    + ">" : i + "<" + c + ">" + d.toString() + "</" + c + ">"
            }
            return g
    ...
    if (a.nodeType === 1) {
        if (a.attributes.length) {
            var e;
            for (e = 0; e < a.attributes.length; e += 1)b["@" + a.attributes[e].nodeName] =
                                                        (a.attributes[e].nodeValue || "").toString()
        }
        if (a.firstChild) {
            var f = e = 0, d = false, c;
            for (c = a.firstChild; c; c = c.nextSibling)if (c.nodeType === 1)d = true; else if (c
                                                                                                    .nodeType
                                                                                                    === 3
                && c.nodeValue.match(/[^ \f\n\r\t\v]/))e += 1; else if (c.nodeType === 4)f += 1;
            if (d)if (e < 2 && f < 2) {
                this.removeWhite(a);
                for (c = a.firstChild; c; c = c.nextSibling)if (c.nodeType === 3)b["#text"] =
                                                                                 this.escape(c
                                                                                                 .nodeValue); else if (c
                                                                                                                           .nodeType
                    === 4)if (h.test(c.nodeValue))b[c.nodeName] =
                                                  [b[c.nodeName], c.nodeValue]; else b["#cdata"] =
                                                                                     this.escape(c
                                                                                                     .nodeValue); else if (b[c
                    .nodeName])if (b[c.nodeName]instanceof Array)b[c.nodeName][b[c.nodeName]
                    .length] = this.toObj(c); else b[c.nodeName] =
                                                   [b[c.nodeName], this.toObj(c)]; else b[c
                    .nodeName] = this.toObj(c)
            } else if (a.attributes.length)b["#text"] = this.escape(this.innerXml(a));
            else b = this.escape(this.innerXml(a)); else if (e)if (a.attributes.length)b["#text"] =
                                                                                       this
                                                                                           .escape(this
                                                                                                       .innerXml(a)); else {
                b = this.escape(this.innerXml(a));
                if (b === "__EMPTY_ARRAY_")b = "[]"; else if (b === "__EMPTY_STRING_")b = ""
            } else if (f)if (f > 1)b = this.escape(this.innerXml(a)); else for (c = a.firstChild; c;
                                                                                c =
                                                                                c.nextSibling)if (h
                    .test(a.firstChild.nodeValue)) {
    ...
    if (a === "[]")f += b ? ":[]" : "[]"; else if (a instanceof Array) {
        ...
        f +=
        (b ? ":[" : "[") + (k.length > 1 ? c + h + d + k.join("," + c + h + d) + c + h : k.join(""))
            + "]"
    } else if (a === null)f += (b && ":") + "null"; else if (typeof a === "object") {
        i = [];
        for (g in a)if (a.hasOwnProperty(g))i[i.length] = this.toJson(a[g], g, h + d, e);
        f += (b ?
              ":{" : "{") + (i.length > 1 ? c + h + d + i.join("," + c + h + d) + c + h : i
            .join("")) + "}"
    } else f +=
           typeof a === "string" ? (b && ":") + '"' + a.replace(/\\/g, "\\\\").replace(/\"/g, '\\"')
               + '"' : (b && ":") + '"' + a.toString() + '"';
    return f
}, innerXml: function (a) {
    var b = "";
    if ("innerHTML"in a)b = a.innerHTML; else {
        var h = function (e) {
            ...
            if (e.nodeType === 1) {
                f += "<" + e.nodeName;
                for (d = 0; d < e.attributes.length; d += 1)f +=
                                                            " " + e.attributes[d].nodeName + '="'
                                                                + (e.attributes[d].nodeValue || "")
                                                                .toString() + '"';
                if (e.firstChild) {
                    f += ">";
            ...
            } else if (e.nodeType === 3)f += e.nodeValue; else if (e.nodeType === 4)f +=
                                                                                    "<![CDATA[" + e
                                                                                        .nodeValue
                                                                                        + "]]\>";
            return f
...
function tableToGrid(n, o) {
    jQuery(n).each(function () {
        if (!this.grid) {
            ...
            var a = jQuery(this).width(), d = jQuery("tr td:first-child input[type=checkbox]:first",
                                                     jQuery(this)), b = jQuery("tr td:first-child input[type=radio]:first",
                                                                               jQuery(this));
            d = d.length > 0;
            b = !d && b.length > 0;
            var l = d || b, c = [], g = [];
            jQuery("th", jQuery(this)).each(function () {
                if (c.length === 0 && l) {
                    ...
                    c.push({name: jQuery(this).attr("id") ||
                                  jQuery.trim(jQuery.jgrid.stripHtml(jQuery(this).html()))
                                      .split(" ").join("_"), index: jQuery(this).attr("id")
                        || jQuery.trim(jQuery.jgrid.stripHtml(jQuery(this).html())).split(" ")
                                                                        .join("_"), width: jQuery(this)
                                                                                               .width()
                        || 150});
            ...
            jQuery(this).jqGrid(jQuery
                                    .extend({datatype: "local", width: a, colNames: g, colModel: c, multiselect: d},
                                            o || {}));
            for (a = 0; a < f.length; a++) {
                b = null;
                if (h.length > 0)if ((b = h[a]) && b.replace)b =
...
(function (a) {
    ...
    if (a.ui)if (a.ui.multiselect) {
            ...
            a.ui.multiselect.prototype._setSelected = function (b, h) {
                ...
                if (h && this.selectedList) {
                    ...
                    this.selectedList.find("li").each(function () {
                        a(this).data("optionLink") && a(this).data("optionLink").remove()
                            .appendTo(f)
                    })
                }
                return c
        ...
        if (a.ui.multiselect.prototype.destroy)a.ui.multiselect.prototype.destroy =
                                               function () {
                                                   ...
                                                   a.Widget === undefined ? a.widget.prototype
                                                       .destroy.apply(this, arguments) : a.Widget
    ...
    a.jgrid.extend({sortableColumns: function (b) {
        return this.each(function () {
            ...
            var c = this, f = c.p.id;
            f =
            {tolerance: "pointer", axis: "x", scrollSensitivity: "1", items: ">th:not(:has(#jqgh_"
                                                                                 + f + "_cb,#jqgh_"
                                                                                 + f + "_rn,#jqgh_"
                                                                                 + f
                + "_subgrid),:hidden)", placeholder: {element: function (g) {
                return a(document.createElement(g[0].nodeName)).addClass(g[0].className +
                                                                         " ui-sortable-placeholder ui-state-highlight")
                    .removeClass("ui-sortable-helper")[0]
            }, update: function (g, j) {
                j.height(g.currentItem.innerHeight() - parseInt(g.currentItem.css("paddingTop")
                                                                    || 0, 10) - parseInt(g
                                                                                             .currentItem
                                                                                             .css("paddingBottom")
                                                                                             || 0,
                                                                                         10));
                j.width(g.currentItem.innerWidth() - parseInt(g.currentItem.css("paddingLeft") || 0,
                                                              10) - parseInt(g.currentItem
                                                                                 .css("paddingRight")
                                                                                 || 0, 10))
            }}, update: function (g, j) {
            ...
            if (c.p.sortable.options)a.extend(f, c.p.sortable.options); else if (a.isFunction(c.p
                                                                                                  .sortable))c
                                                                                                                 .p
                                                                                                                 .sortable =
                                                                                                             {update: c
        ...
        function h(d, k) {
            if (d)if (typeof d == "string")a.fn[d] && a.fn[d].apply(k, a.makeArray(arguments)
                .slice(2)); else a.isFunction(d) && d.apply(k, a.makeArray(arguments).slice(2))
        }

        var c = this;
        if (!a("#colchooser_" + c[0].p.id).length) {
            var f = a('<div id="colchooser_' + c[0].p.id
                          + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), e = a("select",
                                                                                                                                         f);
            b = a.extend({width: 420,
                    ...
                    return{buttons: k, close: function () {
                        d.cleanup(true)
                    }, modal: d.modal ? d.modal : false, resizable: d.resizable ? d.resizable
                        : true, width: d.width + 20}
                }, apply_perm: function () {
                    a("option", e).each(function () {
                        this.selected ? c.jqGrid("showCol", g[this.value].name) : c
                            .jqGrid("hideCol",
                                    g[this.value].name)
                    });
                    var d = [];
            ...
            var g =
                c.jqGrid("getGridParam", "colModel"), j = c.jqGrid("getGridParam",
                                                                   "colNames"), i = {}, l = [];
            e.empty();
            a.each(g, function (d) {
                i[this.name] = d;
                if (this.hidedlg)this.hidden || l.push(d); else e.append("<option value='" + d
                                                                             + "' " + (this.hidden
                    ? "" : "selected='selected'") + ">" + j[d] + "</option>")
            });
            ...
            if (h.grid)if (!h.p.treeGrid)if (a.fn.sortable) {
                ...
                b.update = function (c, f) {
                    ...
                    h.p.rownumbers === true && a("td.jqgrid-rownum", h.rows).each(function (e) {
                        a(this).html(e + 1 + (parseInt(h.p.page, 10) - 1) * parseInt(h.p.rowNum,
                                                                                     10))
                    });
        ...
        return this.each(function () {
            function h() {
                var e = a.data(c, "dnd");
                a("tr.jqgrow:not(.ui-draggable)", c).draggable(a.isFunction(e.drag) ? e.drag
                    .call(a(c), e) : e.drag)
            }
                ...
                if (typeof b == "string" && b == "updateDnD" && c.p.jqgdnd === true)h(); else {
                    b = a.extend({drag: function (e) {
                        return a.extend({start: function (g, j) {
                            ...
                            for (i = 0; i < a.data(c, "dnd").connectWith.length; i++)a(a.data(c,
                                                                                              "dnd")
                                                                                           .connectWith[i])
                                                                                         .jqGrid("getGridParam",
                                                                                                 "reccount")
                                                                                         == "0"
                            && a(a.data(c, "dnd").connectWith[i]).jqGrid("addRowData",
                                                                         "jqg_empty_row", {});
                        ...
                        return a.extend({accept: function (g) {
                            ...
                            if (a(j.draggable).hasClass("jqgrow")) {
                                ...
                                if (!e.dropbyname) {
                                    var l =
                                        0, m = {}, d, k = a("#" + this.id).jqGrid("getGridParam",
                                                                                  "colModel");
                                    try {
                                        for (var p in i) {
                                ...
                                if (e.beforedrop && a.isFunction(e.beforedrop)) {
                                    ...
                                    if (typeof d != "undefined" && d !== null && typeof d
                                        == "object")i = d
                                }
                                if (j.helper.dropped) {
                                    var n;
                                    if (e.autoid)if (a.isFunction(e.autoid))n =
                                                                            e.autoid.call(this,
                                                                                          i); else {
                    ...
                    if (b.connectWith) {
                        ...
                        c.p.jqgdnd = true;
                        for (var f = 0; f < b.connectWith.length; f++)a(b.connectWith[f])
                            .droppable(a.isFunction(b.drop) ? b.drop.call(a(c), b) : b.drop)
                    }
                }
            }
        })
        ...
        return this.each(function () {
            ...
            if (h.grid && a.fn.resizable) {
                ...
                b.alsoResize =
                b._alsoResize_ ? eval("(" + ("{'#gview_" + h.p.id + " .ui-jqgrid-bdiv':true,'" + b
                    ._alsoResize_ + "':true}") + ")") : a(".ui-jqgrid-bdiv", "#gview_" + h.p.id);
