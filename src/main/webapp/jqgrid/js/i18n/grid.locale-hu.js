    ...
    $.jgrid = {
        ...
        search: {
            ...
            odata: ['egyenlő', 'nem egyenlő', 'kevesebb', 'kevesebb vagy egyenlő', 'nagyobb',
                    'nagyobb vagy egyenlő', 'ezzel kezdődik', 'nem ezzel kezdődik', 'tartalmaz',
                    'nem tartalmaz', 'végződik', 'nem végződik', 'tartalmaz', 'nem tartalmaz'],
            groupOps: [
                { op: "AND", text: "all" },
                { op: "OR", text: "any" }
            ],
        ...
        formatter: {
            ...
            date: {
                ...
                monthNames: [
                    ...
                    "Dec",
                    "Január", "Február", "Március", "Áprili", "Május", "Június", "Július",
