...
(function ($) {
    ...
    $.jgrid = {
        ...
        search: {
            ...
            Find: "بحث",
            Reset: "إلغاء",
            odata: ['يساوي', 'يختلف', 'أقل', 'أقل أو يساوي', 'أكبر', 'أكبر أو يساوي', 'يبدأ بـ',
                    'لا يبدأ بـ', 'est dans', "n'est pas dans", 'ينته بـ', 'لا ينته بـ', 'يحتوي',
                    'لا يحتوي'],
            groupOps: [
                { op: "مع", text: "الكل" },
                { op: "أو", text: "لا أحد" }
        ...
        formatter: {
            ...
            date: {
                ...
                monthNames: [
                    "جانفي", "فيفري", "مارس", "أفريل", "ماي", "جوان", "جويلية", "أوت", "سبتمبر",
