...
(function ($) {
    ...
    $.jgrid = {
        ...
        search: {
            ...
            Find: "Szukaj",
            Reset: "Czyść",
            odata: ['dok\u0142adnie', 'różne od', 'mniejsze od', 'mniejsze lub równe', 'większe od',
                    'większe lub równe', 'zaczyna się od', 'nie zaczyna się od', 'zawiera',
                    'nie zawiera', 'kończy się na', 'nie kończy się na', 'zawiera', 'nie zawiera'],
            groupOps: [
        ...
        formatter: {
            ...
            date: {
                ...
                monthNames: [
                    "Sty", "Lu", "Mar", "Kwie", "Maj", "Cze", "Lip", "Sie", "Wrz", "Paź", "Lis",
                    "Gru",
