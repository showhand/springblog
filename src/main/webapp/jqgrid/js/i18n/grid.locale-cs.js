...
(function ($) {
    ...
    $.jgrid = {
        ...
        search: {
            ...
            Find: "Hledat",
            Reset: "Reset",
            odata: ['rovno', 'nerovono', 'menší', 'menší nebo rovno', 'větší', 'větší nebo rovno',
                    'začíná s', 'nezačíná s', 'je v', 'není v', 'končí s', 'nekončí s', 'obahuje',
                    'neobsahuje'],
            groupOps: [
                { op: "AND", text: "všech" },
        ...
        formatter: {
            ...
            date: {
                ...
                monthNames: [
                    "Led", "Úno", "Bře", "Dub", "Kvě", "Čer", "Čvc", "Srp", "Zář", "Říj", "Lis",
                    "Pro",
