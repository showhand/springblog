...
// Give the init function the jQuery prototype for later instantiation
        ...
        jQuery.extend({
                          ...
                          isPlainObject: function (obj) {
                              ...
                              if (!obj || jQuery.type(obj) !== "object" || obj.nodeType || jQuery
                                  .isWindow(obj)) {
                                  return false;
                              }
...
// Convert String-formatted flags into Object-formatted ones and store in cache
                                          ...
                                          jQuery.each({
                                              ...
                                              if (jQuery.isFunction(fn)) {
                                                  deferred[ handler ](function () {
                                                      ...
                                                      if (returned && jQuery.isFunction(returned
                                                                                            .promise)) {
    ...
    jQuery.support = (function () {
        ...
        if (window.getComputedStyle) {
            ...
            ( parseInt(( window.getComputedStyle(marginDiv, null) || { marginRight: 0 } )
                           .marginRight, 10) || 0 ) === 0;
        }
    ...
    jQuery.extend({
                      ...
                      hasData: function (elem) {
                          elem =
                          elem.nodeType ? jQuery.cache[ elem[jQuery.expando] ] : elem[ jQuery
                              .expando ];
                      ...
                      removeData: function (elem, name, pvt /* Internal Use Only */) {
                          ...
                          if (name) {
                              ...
                              if (thisCache) {
                                  ...
                                  if (!( pvt ? isEmptyDataObject : jQuery
                         ...
                         data: function (key, value) {
                             ...
                             if (typeof key === "undefined") {
                                 if (this.length) {
                                     ...
                                     if (this[0].nodeType === 1 && !jQuery._data(this[0],
                                                                                 "parsedAttrs")) {
    ...
    jQuery.fn.extend({
                         ...
                         val: function (value) {
                             ...
                             if (!arguments.length) {
                                 if (elem) {
                                     hooks =
                                     jQuery.valHooks[ elem.nodeName.toLowerCase() ] || jQuery
                                         .valHooks[ elem.type ];
                             ...
                             return this.each(function (i) {
                                 ...
                                 hooks =
                                 jQuery.valHooks[ this.nodeName.toLowerCase() ] || jQuery
                                     .valHooks[ this.type ];
                          ...
                          select: {
                              get: function (elem) {
                                  ...
                                  for (; i < max; i++) {
                                      ...
                                      if (option.selected && (jQuery.support.optDisabled ? !option
                          ...
                          tabIndex: {
                              get: function (elem) {
                                  ...
                                  return attributeNode && attributeNode.specified ?
                                         ...
                                         rfocusable.test(elem.nodeName) || rclickable.test(elem
                                                                                               .nodeName)
                                             && elem.href ?
                                         0 :
                                         undefined;
...
// Radios and checkboxes getter/setter
    ...
    jQuery.event = {
        ...
        add: function (elem, types, handler, data, selector) {
            ...
            if (!eventHandle) {
                elemData.handle = eventHandle = function (e) {
                    ...
                    return typeof jQuery !== "undefined" && (!e || jQuery.event.triggered !== e
                        .type) ?
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default || special._default.apply(elem.ownerDocument, data)
                    === false) && !(type === "click" && jQuery.nodeName(elem, "a")) && jQuery
                        .acceptData(elem)) {
                    ...
                    if (ontype && elem[ type ] && ((type !== "focus" && type !== "blur") || event
                                                                                                .target
                                                                                                .offsetWidth
        ...
        dispatch: function (event) {
            ...
            if (delegateCount && !event.target.disabled && !(event.button && event.type
                === "click")) {
                ...
                for (cur = event.target; cur != this; cur = cur.parentNode || this) {
                    ...
                    for (i = 0; i < delegateCount; i++) {
                        ...
                        if (selMatch[ sel ] === undefined) {
                            selMatch[ sel ] = (
                                              handleObj.quick ? quickIs(cur, handleObj.quick)
                                                  : jqcur.is(sel)
                                              );
                        }
                        if (selMatch[ sel ]) {
            ...
            for (i = 0; i < handlerQueue.length && !event.isPropagationStopped(); i++) {
                ...
                for (j = 0; j < matched.matches.length && !event.isImmediatePropagationStopped();
                    ...
                    if (run_all || (!event.namespace && !handleObj.namespace) || event.namespace_re
                        ...
                        ret =
                        ( (jQuery.event.special[ handleObj.origType ] || {}).handle || handleObj
                            .handler )
        ...
        var Expr = Sizzle.selectors = {
            ...
            filter: {
                ...
                TAG: function (elem, match) {
                    return (match === "*" && elem.nodeType === 1) || !!elem.nodeName && elem
                                                                                            .nodeName
                                                                                            .toLowerCase()
                        === match;
                },
...
// querying by getElementById (and provide a workaround)
        (function () {
            ...
            if (document.getElementById(id)) {
                ...
                Expr.filter.ID = function (elem, match) {
                    var node = typeof elem.getAttributeNode !== "undefined" && elem
                        .getAttributeNode("id");
                ...
                Sizzle = function (query, context, extra, seed) {
                    ...
                    if (!seed && !Sizzle.isXML(context)) {
                        ...
                        if (match && (context.nodeType === 1 || context.nodeType === 9)) {
                            ...
                            } else if (match[2] && Expr.find.CLASS && context
        ...
        (function () {
            var html = document.documentElement,
                matches = html.matchesSelector || html.mozMatchesSelector || html
                    .webkitMatchesSelector || html.msMatchesSelector;
                                 ...
                                 while (cur && cur.ownerDocument && cur !== context) {
                                     for (i = 0; i < selectors.length; i++) {
                                         ...
                                         if (jQuery(cur).is(selectors[ i ])) {
                                             ret
                                                 .push({ selector: selectors[ i ], elem: cur, level: level });
                                         }
                                     }
                             ...
                             for (i = 0, l = this.length; i < l; i++) {
                                 ...
                                 while (cur) {
                                     if (pos ? pos.index(cur) > -1 : jQuery.find
                                         ...
                                         cur = cur.parentNode;
                                         if (!cur || !cur.ownerDocument || cur === context || cur
                                                                                                  .nodeType
                                             === 11) {
                                             break;
                                         }
                             ...
                             if (value === undefined) {
                                 ...
                                 // See if we can take a shortcut and just use innerHTML
                                        ...
                                        (jQuery.support.leadingWhitespace || !rleadingWhitespace
                                            .test(value)) && !wrapMap[ (rtagName.exec(value) || ["",
                                                                                                 ""
                             ])[1].toLowerCase() ]) {
    ...
    jQuery.extend({
                      clone: function (elem, dataAndEvents, deepDataAndEvents) {
                          ...
                          // IE<=8 does not properly clone detached, unknown element nodes
                              clone = jQuery.support.html5Clone || !rnoshimcache.test("<" + elem
                                  .nodeName) ?
                                      elem.cloneNode(true) :
                                      shimCloneNode(elem);

                          if ((!jQuery.support.noCloneEvent || !jQuery.support.noCloneChecked) &&
                              (elem.nodeType === 1 || elem.nodeType === 11) && !jQuery
                              .isXMLDoc(elem)) {
                             ...
                             return this.map(function () {
                                 ...
                                 .filter(function () {
                                             return this.name && !this.disabled &&
                                                    ( this.checked || rselectTextarea.test(this
                                                                                               .nodeName)
                                                        ||
...
// Attach a bunch of functions for handling common AJAX events
    ...
    jQuery.extend({
                      ...
                      ajax: function (url, options) {
                          ...
                          s.url =
                          ( ( url || s.url ) + "" ).replace(rhash, "").replace(rprotocol,
                                                                               ajaxLocParts[ 1 ]
                                                                                   + "//");
        ...
        if (s.dataTypes[ 0 ] === "jsonp" ||
            ...
            var responseContainer,
                jsonpCallback = s.jsonpCallback =
                                jQuery.isFunction(s.jsonpCallback) ? s.jsonpCallback() : s
                                    .jsonpCallback,
    ...
    jQuery.fn.extend({
                             ...
                             if (speed || speed === 0) {
                                 ...
                                 for (; i < j; i++) {
                                     ...
                                     if (elem.style) {
                                         ...
                                         if (display !== "none" && !jQuery._data(elem,
                                                                                 "olddisplay")) {
                             ...
                             function doAnimation() {
                                 ...
                                 for (p in prop) {
                                     ...
                                     if (jQuery.isArray(val)) {
                                         ...
                                         opt.specialEasing && opt.specialEasing[ name ] || opt
                                             .easing || 'swing';
                                     }
                                 ...
                                 for (p in prop) {
                                     ...
                                     if (rfxtypes.test(val)) {
                                         ...
                                         method =
                                         jQuery._data(this, "toggle" + p) || ( val === "toggle"
                                             ? hidden ? "show" : "hide" : 0 );
                                         if (method) {
                         ...
                         stop: function (type, clearQueue, gotoEnd) {
                             ...
                             return this.each(function () {
                                 ...
                                 if (type == null) {
                                     for (index in data) {
                                         if (data[ index ] && data[ index ].stop && index
                                                                                        .indexOf(".run")
                                             === index.length - 4) {
    ...
    jQuery.extend({
                      speed: function (speed, easing, fn) {
                          ...
                          jQuery.fx.off ? 0 : typeof opt.duration === "number" ? opt.duration :
                                              opt.duration in jQuery.fx.speeds ? jQuery.fx
                                                  .speeds[ opt.duration ] : jQuery.fx.speeds
                                                  ._default;
        ...
        step: function (gotoEnd) {
            ...
            if (gotoEnd || t >= options.duration + this.startTime) {
                ...
                if (options.duration == Infinity) {
                    ...
                    this.pos =
                    jQuery.easing[ options.animatedProperties[this.prop] ](this.state, n, 0, 1,
                                                                           options.duration);
    ...
    if ("getBoundingClientRect" in document.documentElement) {
        jQuery.fn.offset = function (options) {
            ...
            var body = doc.body,
                ...
                scrollTop = win.pageYOffset || jQuery.support.boxModel && docElem.scrollTop || body
                    .scrollTop,
        ...
        jQuery.fn.offset = function (options) {
            ...
            var computedStyle,
                ...
                prevComputedStyle = defaultView ? defaultView.getComputedStyle(elem, null) : elem
                    .currentStyle,
                top = elem.offsetTop,
            ...
            while ((elem = elem.parentNode) && elem !== body && elem !== docElem) {
                ...
                if (elem === offsetParent) {
                    ...
                    if (jQuery.support.doesNotAddBorder && !(jQuery.support
    ...
    jQuery.offset = {
        ...
        setOffset: function (elem, options, i) {
            ...
            var curElem = jQuery(elem),
                ...
                calculatePosition = ( position === "absolute" || position === "fixed" ) && jQuery
                                                                                               .inArray("auto",
                                                                                                        [
                                                                                                            curCSSTop,
                                                                                                            curCSSLeft
