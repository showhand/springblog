...
CKEDITOR.dialog.add('uicolor', function (a) {
    ...
    d =
    {id: 'yuiColorPicker', type: 'html', html: "<div id='" + f
        + "' class='cke_uicolor_picker' style='width: 360px; height: 200px; position: relative;'></div>", onLoad: function (j) {
        var k = CKEDITOR.getUrl('plugins/uicolor/yui/');
        c =
        new window.YAHOO.widget.ColorPicker(f,
                                            {showhsvcontrols: true, showhexcontrols: true, images: {PICKER_THUMB: k
                                                + 'assets/picker_thumb.png', HUE_THUMB: k
    ...
    return{title: a.lang.uicolor.title, minWidth: 360, minHeight: 320, onLoad: function () {
        ...
        {id: 'tab1', label: '', title: '', expand: true, padding: 0, elements: [d,
                                                                                {id: 'tab1', type: 'vbox', children:
                                                                                    [
                                                                                        {id: 'livePeview', type: 'checkbox', label: a
                                                                                            .lang
                                                                                            .uicolor
                                                                                            .preview, 'default': 1, onLoad: function () {
                                                                                            i =
                                                                                            true;
                                                                                        }, onChange: function () {
                                                                                            if (i) {
                                                                                        ...
                                                                                        {type: 'hbox', children:
                                                                                            [
                                                                                                {id: 'predefined', type: 'select', 'default': '', label: a
                                                                                                    .lang
                                                                                                    .uicolor
                                                                                                    .predefined, items:
                                                                                                    [
                                                                                        ...
                                                                                        {id: 'configBox', type: 'text', label: a
                                                                                            .lang
                                                                                            .uicolor
