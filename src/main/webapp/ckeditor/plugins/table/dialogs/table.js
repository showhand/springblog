...
(function () {
    ...
    function d(e, f) {
        ...
        return{title: e.lang.table.title, minWidth: 310, minHeight: CKEDITOR.env.ie ? 310
            : 280, onLoad: function () {
            ...
            if (j) {
                j.on('change', function (k) {
                    ...
                    m && m.setValue(l, true);
                    var n = this.getStyle('height', ''), o = i.getContentElement('info',
                                                                                 'txtHeight');
                    o && o.setValue(n, true);
                });
            }
            ...
            var i = e.getSelection(), j = i.getRanges(), k = null, l = q.getContentElement('info',
                                                                                           'txtRows'), m = q
                .getContentElement('info', 'txtCols'), n = q.getContentElement('info',
                                                                               'txtWidth'), o = q
            ...
            var i = e.getSelection(), j = this._.selectedElement && i.createBookmarks(), k = this._
                                                                                                 .selectedElement
                || g('table'), l = this, m = {};
            ...
            if (m.info) {
                ...
                if (!this._.selectedElement) {
                    var o = k.append(g('tbody')), p = parseInt(n.txtRows, 10) || 0, q = parseInt(n
                                                                                                     .txtCols,
                                                                                                 10)
                        || 0;
                    for (var r = 0; r < p; r++) {
            ...
            if (!this._.selectedElement) {
                e.insertElement(k);
                setTimeout(function () {
                    var B = new CKEDITOR.dom.element(k.$.rows[0].cells[0]), C = new CKEDITOR.dom
                        .range(e.document);
            ...
            {id: 'info', label: e.lang.table.title, elements: [
                {type: 'hbox', widths: [null, null], styles: ['vertical-align:top'], children: [
                    {type: 'vbox', padding: 0, children: [
                        {type: 'text', id: 'txtRows', 'default': 3, label: e.lang.table
                            .rows, required: true, controlStyle: 'width:5em', validate: function () {
                        ...
                        {type: 'text', id: 'txtCols', 'default': 2, label: e.lang.table
                            .columns, required: true, controlStyle: 'width:5em', validate: function () {
                            var i = true, j = this.getValue();
                            i = i && CKEDITOR.dialog.validate.integer()(j) && j > 0;
                            if (!i) {
                        ...
                        {type: 'html', html: '&nbsp;'},
                        {type: 'select', id: 'selHeaders', 'default': '', label: e.lang.table
                            .headers, items: [
                            ...
                            if (i.$.tHead !== null) {
                                this.setValue(j.hasColumnHeaders ? 'both'
                                                  : 'row');
                            } else {
                                this.setValue(j
                                                  .hasColumnHeaders
                        ...
                        {type: 'text', id: 'txtBorder', 'default': 1, label: e.lang.table
                            .border, controlStyle: 'width:3em', validate: CKEDITOR.dialog.validate
                            .number(e.lang.table.invalidBorder), setup: function (i) {
                        ...
                        {id: 'cmbAlign', type: 'select', 'default': '', label: e.lang.common
                            .align, items: [
                    ...
                    {type: 'vbox', padding: 0, children: [
                        {type: 'hbox', widths: ['5em'], children: [
                            {type: 'text', id: 'txtWidth', controlStyle: 'width:5em', label: e.lang
                                .common.width, title: e.lang.common
                                .cssLengthTooltip, 'default': 500, getValue: a, validate: CKEDITOR
                                .dialog.validate.cssLength(e.lang.common.invalidCssLength
                                                               .replace('%1', e.lang.common
                        ...
                        {type: 'hbox', widths: ['5em'], children: [
                            {type: 'text', id: 'txtHeight', controlStyle: 'width:5em', label: e.lang
                                .common.height, title: e.lang.common
                                .cssLengthTooltip, 'default': '', getValue: a, validate: CKEDITOR
                                .dialog.validate.cssLength(e.lang.common.invalidCssLength
                                                               .replace('%1', e.lang.common
                        ...
                        {type: 'html', html: '&nbsp;'},
                        {type: 'text', id: 'txtCellSpace', controlStyle: 'width:3em', label: e.lang
                            .table.cellSpace, 'default': 1, validate: CKEDITOR.dialog.validate
                            .number(e.lang.table.invalidCellSpacing), setup: function (i) {
                            this.setValue(i.getAttribute('cellSpacing') || '');
                        }, commit: function (i, j) {
                            if (this.getValue()) {
                                j.setAttribute('cellSpacing',
                                               this.getValue());
                            } else {
                                j
                        ...
                        {type: 'text', id: 'txtCellPad', controlStyle: 'width:3em', label: e.lang
                            .table.cellPad, 'default': 1, validate: CKEDITOR.dialog.validate
                            .number(e.lang.table.invalidCellPadding), setup: function (i) {
                            this.setValue(i.getAttribute('cellPadding') || '');
                        }, commit: function (i, j) {
                            if (this.getValue()) {
                                j.setAttribute('cellPadding',
                                               this.getValue());
                            } else {
                                j
                ...
                {type: 'vbox', padding: 0, children: [
                    {type: 'text', id: 'txtCaption', label: e.lang.table
                        .caption, setup: function (i) {
                        var m = this;
                        m.enable();
                        var j = i.getElementsByTag('caption');
                        if (j.count() > 0) {
                            var k = j.getItem(0), l = k.getFirst(CKEDITOR.dom.walker
                                                                     .nodeType(CKEDITOR
                                                                                   .NODE_ELEMENT));
                    ...
                    {type: 'text', id: 'txtSummary', label: e.lang.table
                        .summary, setup: function (i) {
