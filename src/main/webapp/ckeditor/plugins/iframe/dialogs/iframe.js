...
(function () {
    ...
    CKEDITOR.dialog.add('iframe', function (d) {
        ...
        return{title: e.title, minWidth: 350, minHeight: 260, onShow: function () {
            ...
            if (h && h.data('cke-real-element-type') && h.data('cke-real-element-type')
                == 'iframe') {
                j.fakeImage = h;
            ...
            {id: 'info', label: f.generalTab, accessKey: 'I', elements: [
                {type: 'vbox', padding: 0, children: [
                    {id: 'src', type: 'text', label: f.url, required: true, validate: CKEDITOR
                        .dialog.validate.notEmpty(e.noUrl), setup: b, commit: c}
                ]},
                {type: 'hbox', children: [
                    {id: 'width', type: 'text', style: 'width:100%', labelLayout: 'vertical', label: f
                        .width, validate: CKEDITOR.dialog.validate.htmlLength(f.invalidHtmlLength
                                                                                  .replace('%1', f
                        .width)), setup: b, commit: c},
                    {id: 'height', type: 'text', style: 'width:100%', labelLayout: 'vertical', label: f
                        .height, validate: CKEDITOR.dialog.validate.htmlLength(f.invalidHtmlLength
                                                                                   .replace('%1', f
                        .height)), setup: b, commit: c},
                    ...
                    ], style: 'width:100%', labelLayout: 'vertical', label: f
                        .align, setup: function (h, i) {
