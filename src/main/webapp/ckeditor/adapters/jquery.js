...
(function () {
    ...
    typeof CKEDITOR.config.jqueryOverrideVal == 'undefined' ? true : CKEDITOR.config
        .jqueryOverrideVal;
    var a = window.jQuery;
    ...
    a.extend(a.fn, {ckeditorGet: function () {
        ...
        this.filter('textarea, div, p').each(function () {
            ...
            if (f && !g) {
                ...
                if (c.autoUpdateElement || typeof c.autoUpdateElement == 'undefined' && CKEDITOR
                ...
                f.on('instanceReady', function (i) {
                    ...
                    setTimeout(function () {
                        ...
                        if (j.config.autoUpdateElementJquery && e.is('textarea') && e
                            .parents('form').length) {
                            var k = function () {
                                e.ckeditor(function () {
                                    j.updateElement();
    ...
    if (CKEDITOR.config.jqueryOverrideVal) {
        a.fn.val =
        CKEDITOR.tools.override(a.fn.val, function (b) {
            return function (c, d) {
